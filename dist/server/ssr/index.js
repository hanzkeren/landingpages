...
const ElementsContext = /* @__PURE__ */ reactExports.createContext(null);
const ChildrenContext = /* @__PURE__ */ reactExports.createContext(void 0);
const ChildrenContextProvider = /* @__PURE__ */ reactExports.memo(ChildrenContext);
...
const Slot = ({ id, children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChildrenContextProvider, {
    value: children,
    children: element
  });
};
const INTERNAL_ServerRoot = ({ elementsPromise, children }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(ElementsContext, {
...
const renderHtmlStream = async (rscStream, rscHtmlStream, options) => {
  ...
  function SsrRoot() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(INTERNAL_ServerRoot, {
      elementsPromise,
      children: reactExports.use(htmlPromise)
    });
  }
  ...
  try {
    htmlStream = await server_edgeExports.renderToReadableStream(/* @__PURE__ */ jsxRuntimeExports.jsx(SsrRoot, {}), {
      ...
      onError: (e) => {
        ...
        console.error("[SSR Error]", reactExports.captureOwnerStack?.() || "", "\n", e);
      },
      ...options?.nonce ? {
        nonce: options.nonce
      } : {},
    ...
    const ssrErrorRoot = /* @__PURE__ */ jsxRuntimeExports.jsx("html", {
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("body", {})
    });
    htmlStream = await server_edgeExports.renderToReadableStream(ssrErrorRoot, {
      bootstrapScriptContent: getBootstrapPreamble({
        rscPath: options?.rscPath || "",
        hydrate: false
      }) + bootstrapScriptContent,
