  ...
  return (
    <section className="relative py-16 md:py-32">
      ...
      <div className="container relative z-10">
        <div>
          <h2 className="text-4xl font-medium sm:text-5xl lg:text-6xl">Our Key Features</h2>
          <p className="text-muted-foreground mt-4 md:text-lg">
            Unlock the full potential of your projects with our powerful and intuitive features.
          </p>
          ...
          <div className="mt-4 lg:mt-8">
            <Tabs value={selection} onValueChange={setSelection}>
              ...
              <div className="relative w-full overflow-hidden">
                {DATA.map((feature) => (
                  <TabsContent key={feature.id} value={feature.id} className="relative z-20">
