    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <h2 className="text-4xl font-medium md:text-5xl">Transform Your Experience</h2>
          <p className="max-w-2xl text-lg text-muted-foreground">
            Discover innovative solutions to elevate your journey. From basics to advanced features,
            experience excellence at each level.
          </p>
        </div>
        <div className="mt-16 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="flex flex-col justify-between gap-20 rounded-2xl bg-muted/50 p-12 md:order-2 md:gap-32 xl:order-2">
            ...
            <div className="">
              <p className="mb-8 text-muted-foreground">
                Experience groundbreaking capabilities that redefine possibilities and unlock
                through innovation.
              </p>
          ...
          <div className="flex flex-col justify-between gap-20 rounded-2xl bg-[#d1efef] p-12 md:order-3 md:gap-32 xl:order-4">
            ...
            <div className="">
              <p className="mb-8 text-white/80">
                Take control of your journey with powerful tools and insights. Achieve goals with
          ...
          <div className="flex flex-col justify-between gap-20 rounded-2xl bg-[#d1efef] p-12 md:order-6 md:gap-32 xl:order-5">
            ...
            <div className="">
              <p className="mb-8 text-muted-foreground">
                Enhance your experience with advanced capabilities. Discover new possibilities for
                growth and success.
              </p>
              <a href="#" className="text-sm underline">
                More Information
          ...
          <div className="flex flex-col justify-between gap-20 rounded-2xl bg-muted/50 p-12 md:order-7 md:gap-32">
            ...
            <div className="">
              <p className="mb-8 text-muted-foreground">
                Access insights and recommendations tailored to your needs. Navigate your path with
                confidence.
              </p>
              <a href="#" className="text-sm underline">
                More Information
