...
import { FaApple, FaGoogle, FaLinkedin, FaMicrosoft, FaTwitter } from 'react-icons/fa';
...
const CARDS = [
  {
    ...
    content: (
      <p>
        ...
        <Highlight>We deployed in under 2 hours</Highlight> and the team loves how intuitive the
        interface is. The responsive design works perfectly across all devices.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        ...
        <Highlight>Easy to customize</Highlight> and the documentation is comprehensive. The
        performance optimizations are noticeable in production.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        ...
        <Highlight>WCAG compliant out of the box</Highlight> and the design system is consistent.
        Our users with disabilities have given us excellent feedback.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        The performance is exceptional. <Highlight>Lightning fast loading times</Highlight> and the
        SEO optimizations have significantly improved our search rankings. Highly recommended for
  ...
  },
  {
    ...
    content: (
      <p>
        Perfect for our enterprise needs. <Highlight>Scalable and secure</Highlight> with excellent
        integration capabilities. The analytics dashboard provides invaluable insights for our
        marketing campaigns.
      </p>
    ),
  },
