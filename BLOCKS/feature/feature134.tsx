    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-4">
          ...
          <h2 className="text-center text-3xl font-semibold lg:text-4xl">Enhance Your Workflow</h2>
          <p className="text-center text-muted-foreground lg:text-lg">
            Discover powerful tools to increase efficiency, simplify tasks, and reach your goals
            faster.
          </p>
        </div>
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          <a href="#" className="flex flex-col rounded-lg border">
            <div className="flex justify-between p-6">
              <div className="flex flex-col gap-1">
                <h3 className="font-medium md:text-lg">Easy Event Scheduling</h3>
                <p className="text-sm text-muted-foreground md:text-base">
                  Plan effortlessly with integrated scheduling for smooth collaboration.
                </p>
              </div>
          ...
          <a href="#" className="flex flex-col justify-between rounded-lg border lg:col-span-2">
            <div className="flex justify-between p-6">
              <div className="flex flex-col gap-1">
