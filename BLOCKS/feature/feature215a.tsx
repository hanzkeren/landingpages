    ...
    <section className="py-24">
      <div className="container">
        <div className="mx-auto mb-16 flex max-w-[47.5rem] flex-col gap-4 text-center">
          <h2 className="text-3xl font-bold xl:text-5xl">Fully Editable Components</h2>
          <p className="text-muted-foreground text-lg">
            Built for developers who value quality, performance, and developer experience. Every
            component is crafted with care and tested in production.
          </p>
        </div>
