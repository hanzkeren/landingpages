  ...
  const resources = [
    {
      ...
      description: 'Choose from hundreds of pre-designed templates tailored to your needs',
      href: '#',
      imageSrc: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-8-wide.svg',
    },
    {
      title: 'Discover the power of No Code',
      description: 'Understand how no-code platforms are revolutionizing software development',
      href: '#',
      imageSrc: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-8-wide.svg',
    },
    {
      title: 'Connect with a certified expert',
      description: 'Get professional help from our network of certified experts',
      href: '#',
      imageSrc: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-8-wide.svg',
    },
  ];
      ...
      <div className="container">
        ...
        <div className="mx-auto mt-12 max-w-5xl rounded-2xl border">
          {resources.map((resource, index) => (
            <div key={index} className={`${index !== resources.length - 1 ? 'border-b' : ''}`}>
              <a
                href={resource.href}
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-6">
                    <h3 className="text-lg font-semibold lg:text-xl">{resource.title}</h3>
