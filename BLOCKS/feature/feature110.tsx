    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto flex max-w-xl flex-col items-center gap-5 text-center">
          ...
          <h2 className="text-3xl font-semibold md:text-5xl">Create, Motivate, and Succeed</h2>
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-7 md:grid-cols-2">
          <div className="flex flex-col gap-7">
            <div className="rounded-xl border bg-muted p-8 md:p-10">
              ...
              <h3 className="mb-2.5 font-semibold md:text-xl">Dynamic Features</h3>
              <p className="text-sm text-muted-foreground md:text-base">
                Elevate your website with advanced design tools and interactive options.
              </p>
              <a href="#" className="mt-5 flex items-center gap-1 text-sm font-medium md:text-base">
          ...
          <div className="flex flex-col gap-7">
            <div className="rounded-xl border bg-muted p-8 md:p-10">
              ...
              <p className="mb-7 text-sm text-muted-foreground">From 15k+ users</p>
              <h3 className="mb-2.5 font-semibold md:text-xl">Unmatched Organization</h3>
              <p className="text-sm text-muted-foreground md:text-base">
                Discover streamlined features for quick edits and optimal results.
              </p>
            </div>
            <div className="rounded-xl border bg-muted p-8 md:p-10">
              ...
              <h3 className="mb-2.5 font-semibold md:text-xl">Highly Structured</h3>
              <p className="text-sm text-muted-foreground md:text-base">
