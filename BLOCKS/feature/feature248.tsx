    ...
    <section className="dark bg-background py-32">
      <div className="container flex flex-col items-center justify-center">
        <TextReveal className="font-medium xl:text-3xl" maxWidth="86rem">
          And the coolest part? This is just the beginning — there&apos;s so much more coming your
          way. From exciting features to game-changing updates, we&apos;re just getting started.
          Stay tuned — the best is yet to come. Big ideas are turning into reality, and you&apos;re
          at the heart of it all. Get ready to experience what&apos;s next.
        </TextReveal>
      </div>
    </section>
  );
...
export const TextReveal: FC<TextRevealProps> = ({ children, title, className, maxWidth }) => {
