...
import { LinkPreview } from '#app/components/aceternity/link-preview';
    ...
    <section className="overflow-hidden py-32">
      <div className="container relative z-20 flex w-full flex-col items-center justify-between gap-10 md:flex-row">
        ...
        <div className="flex gap-5 text-lg lg:gap-10">
          ...
          <ul>
            <li>
              <LinkPreview url="https://shadcnblocks.com" className="opacity-40 hover:opacity-100">
                ShadcnBlocks
              </LinkPreview>
            </li>
            <li>
              <LinkPreview url="https://ui.shadcn.com" className="opacity-40 hover:opacity-100">
                ShadcnUI
              </LinkPreview>
            </li>
            <li>
              <LinkPreview url="https://tailwindcss.com" className="opacity-40 hover:opacity-100">
                TailwindCSS
              </LinkPreview>
            </li>
            <li>
            ...
            <li>
              <LinkPreview url="https://nextjs.org" className="opacity-40 hover:opacity-100">
                NextJS
              </LinkPreview>
            </li>
            <li>
