  ...
  return (
    <section className="py-32">
      <div className="container">
        <h1 className="mb-4 text-center text-4xl font-semibold">Dynamic Layouts</h1>
        <p className="text-center text-muted-foreground">Adapt the box to suit any purpose</p>
        <div className="grid grid-cols-1 gap-y-5 pt-14 xl:grid-cols-3 xl:grid-rows-2 xl:gap-x-5 xl:gap-y-0">
          <a href="#" className="group relative col-span-2 row-span-3 overflow-hidden rounded-xl">
            <img
          ...
          <div className="grid gap-y-5 xl:row-span-2">
            <a href="#" className="group relative overflow-hidden rounded-xl">
              ...
              <div className="absolute top-0 flex h-full w-full flex-col justify-between p-7">
                ...
                <div className="flex flex-col gap-5 text-background">
                  <h4 className="text-2xl font-semibold lg:text-3xl">Explore now</h4>
                  <p className="flex items-center gap-1 font-medium">
            ...
            <a href="#" className="group relative row-span-2 overflow-hidden rounded-xl">
              <img
