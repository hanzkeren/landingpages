      ...
      <div className="container">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-center gap-5">
          ...
          <Card className="w-166 relative h-96 rounded-3xl border">
            <CardHeader>
              <h3 className="text-2xl font-semibold tracking-tight">Customizable Workflows</h3>
          ...
          <Card className="md:w-83 h-96 w-full rounded-3xl border">
            <CardHeader>
              <h3 className="text-2xl font-semibold tracking-tight">Smart Task Tracking </h3>
          ...
          <Card className="w-166 h-96 overflow-hidden rounded-3xl border">
            <CardHeader>
              <h3 className="text-2xl font-semibold tracking-tight">Trusted by 100k Users </h3>
              <p className="text-muted-foreground/70">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt Lorem ipsum dolor sit amet, consectetur
              </p>
  ...
  return (
    ...
    >
      <line
        ...
        strokeOpacity="0.2"
      />
      <line x1="4.54346" y1="0.972656" x2="4.54346" y2="4.625" stroke="black" strokeOpacity="0.2" />
      <line x1="8.54346" y1="0.972656" x2="8.54346" y2="4.625" stroke="black" strokeOpacity="0.2" />
      <line x1="12.5435" y1="0.972656" x2="12.5435" y2="4.625" stroke="black" strokeOpacity="0.2" />
    </svg>
  );
};
