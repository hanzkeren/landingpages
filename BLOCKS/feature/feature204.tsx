          ...
          <div className="flex max-w-2xl flex-col justify-between gap-10">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                Discover powerful tools and resources designed to elevate your projects and
            ...
            <div className="grid gap-7 sm:grid-cols-2">
              <div className="text-center lg:text-left">
                ...
                <h3 className="mt-4 mb-2 text-lg font-semibold">Seamless Integration</h3>
              ...
              <div className="text-center lg:text-left">
                ...
                <h3 className="mt-4 mb-2 text-lg font-semibold">Reliable Performance</h3>
                <p className="text-muted-foreground">
