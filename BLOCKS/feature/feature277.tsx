...
import { ArrowRight, BadgeDollarSign, CodeXml, Plug2, Snowflake } from 'lucide-react';
  ...
  const items = [
    {
      ...
      description: "Track your users' activity in real-time with our advanced analytics",
      icon: Plug2,
      color: 'text-pink-500',
    ...
    },
    {
      ...
      description: 'Affordable pricing for all businesses, with a free tier available',
  ...
  return (
    <section className="overflow-hidden py-32">
      <div className="container flex w-full flex-col items-center justify-center px-4">
        <p className="bg-muted rounded-full px-4 py-1 text-xs uppercase">Examples</p>
...
const Card = ({
  ...
  return (
    ...
    >
      ...
      <Button variant="ghost" className="group/btn mt-8 w-full hover:opacity-50" asChild>
        <a href="#">
          Read More{' '}
