      ...
      <div className="container px-4 md:px-6">
        <div className="relative flex flex-col md:flex-row md:gap-0">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-white md:text-5xl">Streamline Sales</h1>
            <p className="max-w-md text-left text-white/90">
              Streamline your sales process with our innovative CRM software. Manage leads, track
              interactions, and boost your sales efficiency.
            </p>
          </div>
          ...
          >
            ...
            <p className="max-w-md text-left text-white/90 md:text-right">
              Enhance customer satisfaction and retention with our powerful CRM tools. Analyze data
