...
const categories = ['React', 'TailwindCSS', 'TypeScript', 'Express', 'MongoDB', 'Python'];
...
const projects: Project[] = [
  {
    ...
    description: 'A portfolio website built that showcases my projects and skills',
  ...
  return (
    <section className="bg-muted/50 py-32">
      <div className="container">
        <h1 className="text-center text-3xl font-medium md:text-5xl">Explore My Projects</h1>
        <div className="mt-10">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            >
              <Badge
                ...
                className={cn('cursor-pointer', selectedCategory !== null && 'bg-background')}
              >
                All
              </Badge>
              {categories.map((category) => (
                <Badge
                  ...
                  className={cn('cursor-pointer', selectedCategory !== category && 'bg-background')}
                >
                  {category}
                </Badge>
              ))}
          ...
          {filteredProjects.length > 0 ? (
            <>
              <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                {showAllProjects
                  ...
                  : filteredProjects
                      .slice(0, 9)
                      .map((project) => <ProjectCard key={project.title} project={project} />)}
              </div>
            ...
            <div className="mt-16 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-muted-foreground mt-2 max-w-md">
                No projects match your filters. Try adjusting your search criteria or selecting a
                different category.
              </p>
            </div>
          )}
