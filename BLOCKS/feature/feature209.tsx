              ...
              <div className="flex items-center bg-background p-8 xl:w-1/2">
                <div className="flex h-fit flex-col gap-6 py-16 pr-16">
                    ...
                    {images.map((image, index) => (
                      <button
                        ...
                        className={cn(
                          ...
                          selectedImage === image && 'border border-foreground/10 shadow-md'
                        )}
                  ...
                  <p className="font-medium text-muted-foreground">
                    The featured collection provides a sleek gallery-focused experience with
                    customizable album layouts, client testimonials section, and intuitive image
