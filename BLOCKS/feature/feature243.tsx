...
const Feature243 = () => {
  const steps: Step[] = [
    ...
    },
    {
      title: 'Efficiency',
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit.',
      icon: <Gem className="size-10 stroke-white transition-all ease-in-out group-hover:size-12" />,
    },
    {
      title: 'Finalization',
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit.',
      ...
      <div className="container py-32">
        ...
        <div className="gap-18 sm:mt-68 mt-24 flex flex-wrap items-center justify-center sm:gap-6">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative flex w-fit flex-col items-center">
              <div
                className={cn(
