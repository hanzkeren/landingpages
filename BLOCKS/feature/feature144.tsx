  ...
  return (
    <section className="py-32">
      <div className="container">
        <h2 className="text-center text-4xl">Build your website with UI blocks</h2>
        ...
        <Card className="mt-20 flex flex-col gap-6 p-6 md:flex-row md:gap-8 md:p-8">
          <div className="flex w-full flex-col justify-between">
            ...
            <Badge variant="outline" className="mt-4 w-fit bg-muted px-4 py-3 md:text-base">
        ...
        <div className="mt-6 flex flex-col gap-6 md:mt-8 md:flex-row md:gap-8">
          <Card className="flex w-full flex-col gap-6 p-6 md:gap-8 md:p-8">
            ...
            <div className="flex w-full flex-col justify-between">
              ...
              <Badge variant="outline" className="mt-10 w-fit bg-muted px-4 py-3 md:text-base">
                Build website with UI blocks
              </Badge>
            </div>
          </Card>
