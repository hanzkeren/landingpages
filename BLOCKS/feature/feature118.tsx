import { CheckCircle2, LucideGitGraph, MessageSquare, Star, Zap } from 'lucide-react';
      ...
      <div className="container">
        <div className="flex flex-col gap-10">
          <div className="mx-auto flex max-w-xl flex-col gap-2.5 text-center">
            <h1 className="text-4xl font-semibold md:text-5xl">Key Features That Save You Time</h1>
          ...
          <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-3 lg:gap-12">
            <div className="col-span-2 grid gap-7 rounded-lg bg-background p-7 md:grid-cols-2">
              <div className="flex h-full flex-col justify-between gap-3">
                ...
                <p className="text-muted-foreground">
                  Use our powerful tools to simplify reporting and make data-driven decisions
                  faster.
                </p>
              </div>
              <img
          ...
          <div className="grid items-center gap-12 rounded-lg bg-background p-7 md:p-10 lg:grid-cols-3">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground">Rated as the top-performing platform</p>
              </div>
            </div>
          </div>
