import { BoxesIcon, CheckIcon, HeadphonesIcon, PuzzleIcon, ShieldCheckIcon } from 'lucide-react';
...
const cards = [
  {
    ...
    description: 'Discover our comprehensive suite of features designed to enhance workflows.',
    icon: BoxesIcon,
    features: [
    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto grid max-w-3xl gap-9 md:grid-cols-2">
          {cards.map((card, idx) => (
            <div key={idx} className="flex flex-col gap-8 rounded-xl bg-muted p-9">
