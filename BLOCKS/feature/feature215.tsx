      ...
      <Card className="bg-muted h-full min-h-[24rem] p-8 shadow-none transition-all group-hover:shadow-md">
        <CardContent className="p-0">
          <div className="relative">
            <AspectRatio ratio={16 / 9} className="overflow-hidden rounded-[0.5rem]">
              <video
                src={video}
      ...
      <div className="container">
        <div className="mx-auto mb-16 flex max-w-[47.5rem] flex-col gap-6">
          ...
          <p className="text-muted-foreground text-center text-xl">
            A comprehensive component library designed for modern web development. Ship beautiful,
            accessible interfaces in record time with our battle-tested components.
          </p>
        </div>
        <Carousel
          opts={{
