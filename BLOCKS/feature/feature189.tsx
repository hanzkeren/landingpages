        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="max-w-xl max-lg:mx-auto lg:ml-auto">
            ...
            <div className="mt-6 grid gap-6 sm:mt-10 sm:gap-10">
              ...
              <div className="flex items-start gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground sm:text-base">
                    Automate repetitive tasks and streamline your workflow to focus on what truly
                    matters.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div>
                  <p className="font-semibold text-black">Real-time collaboration</p>
                  <p className="mt-1 text-sm text-muted-foreground sm:text-base">
                    Work seamlessly with your team, no matter where they are, with real-time updates
                    and communication.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground sm:text-base">
                    Gain insights into your performance with powerful analytics and data-driven
            ...
            {/* Button */}
            <Button variant="secondary" className="mt-6 flex items-center gap-1 sm:mt-10">
              Learn more
