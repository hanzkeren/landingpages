  ...
  const features = [
    {
      ...
      features: ['Unlimited storage space', 'Automatic file backup', 'Fast retrieval times'],
    },
    {
    ...
    },
    {
      ...
      features: ['DDoS attack prevention', 'SSL certificate management', 'Daily security scanning'],
    },
  ];
