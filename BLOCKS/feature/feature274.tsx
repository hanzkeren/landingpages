...
import { CanvasRevealEffect } from '#app/components/aceternity/canvas-reveal-effect';
...
export const BorderIllustration = ({ className, ...rest }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
