      ...
      <div className="container">
        ...
        <div className="mb-20 flex flex-wrap justify-center gap-12">
          {stats.map((item, i) => (
            <div key={`stats-${i}`} className="min-w-[12rem] text-center">
              <div className="mb-2 text-4xl font-semibold md:text-5xl">{item.number}</div>
              <div className="text-muted-foreground text-sm font-medium">{item.text}</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="order-2 lg:order-1">
            <AspectRatio ratio={0.873239437} className="overflow-hidden rounded-2xl">
              <video
          ...
          <div className="order-1 space-y-6 lg:order-2">
            ...
            <p className="text-muted-foreground text-lg font-medium leading-[1.4] md:text-xl">
              Drag, drop, and customize ready-made components to speed up your workflow and create
              polished UIs in no time.
            </p>
            <div className="pt-4">
