        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex h-fit flex-col gap-4 rounded-lg bg-background/50 p-4">
            <div className="flex flex-row items-center gap-x-2 rounded-lg border bg-card p-4 shadow-sm">
              ...
              <h1 className="truncate text-xl font-bold sm:text-2xl">Analytics Snapshot</h1>
            ...
            <div className="rounded-lg border bg-card p-4 shadow-sm">
              ...
              <div className="my-4">
                <span className="text-xs text-muted-foreground">
                  Recent performance evaluation shows significant improvement in code quality and
                  project delivery times. Consistently meets deadlines and demonstrates strong
                  problem-solving skills. Recommended for consideration in upcoming team lead
                  positions.
                </span>
              </div>
              <div className="flex flex-row items-center">
              ...
              <div>
                <div className="flex flex-row items-center">
                  ...
                  <Progress value={60} className="ml-auto max-w-32 rounded-sm" />
                </div>
          ...
          <div>
            <div className="mt-24 flex flex-col gap-4 rounded-lg bg-background/50 p-4">
              <div className="flex flex-row items-center gap-x-2 rounded-lg border bg-card p-4 shadow-sm">
                <ChartNoAxesColumnIncreasing className="size-6" />
                <h1 className="truncate text-xl font-bold sm:text-2xl">Data Metrics</h1>
                <span className="ml-auto shrink-0 font-mono text-sm text-muted-foreground uppercase">
                  Data/logs/182620
                </span>
              </div>
              ...
              <div className="mt-4 flex flex-col rounded-lg border bg-background/50 p-4 shadow-sm">
                <div className="flex flex-row items-center">
                  ...
                  <span className="ml-4 text-sm text-muted-foreground">Shadcnblocks.com Stats</span>
                </div>
