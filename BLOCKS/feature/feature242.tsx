          ...
          >
                ...
                <CarouselItem key={index} className="px-2 md:basis-1/2 lg:basis-1/3">
                  <div className="bg-muted group relative flex h-full max-h-96 w-full flex-col items-end justify-between text-ellipsis rounded-3xl p-5">
                    ...
                    <div className="flex w-full items-center justify-between gap-4">
                      ...
                      <a href={item.href} className="relative z-10 cursor-pointer">
                        <Button
                          variant="outline"
            ...
            <div className="mt-8 flex w-full items-center justify-between px-4">
              <div className="flex items-center gap-2">
                <span className="text-lg font-medium">{current.toString().padStart(2, '0')}</span>
                <span className="text-muted-foreground">/</span>
                <span className="text-muted-foreground">{count.toString().padStart(2, '0')}</span>
              </div>
