      ...
      <div className="container">
        <div className="m-auto mb-24 max-w-xl">
          <h2 className="mb-6 text-center text-3xl font-semibold lg:text-5xl">
            <span className="text-muted-foreground">Build</span> your website with UI blocks.
          </h2>
          <p className="m-auto max-w-3xl text-center text-lg lg:text-xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro et, ipsa numquam
            asperiores tempora voluptatibus officia culpa eaque odit.
          </p>
          <a
