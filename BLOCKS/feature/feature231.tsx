...
const features = [
  {
    title: 'Modern',
    description: 'Built with the latest web technologies for speed and performance',
  },
  {
    title: 'Responsive',
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
          <div className="space-y-8">
            <h1 className="text-5xl font-semibold tracking-tight sm:text-7xl">
              <span className="mb-2 block text-muted-foreground">Blocks built with</span>
            ...
            <p className="max-w-md text-lg text-muted-foreground">
              Create stunning web experiences with our premium components. Modern, responsive, and
              beautifully crafted for your next project.
            </p>
