...
import { SparklesCore } from '#app/components/aceternity/sparkles';

const features = [
  {
    icon: Globe,
    title: 'Developer Friendly',
    description: 'Built with modern technologies and clean APIs for seamless integration.',
  },
  {
    icon: Box,
    title: 'Lightning Fast',
    description: 'Optimized performance with minimal bundle size and instant loading.',
  },
  {
    icon: ShieldUser,
  ...
  },
  {
    ...
    description: 'Built for teams with real-time collaboration and version control.',
  },
  {
    icon: AudioLines,
    title: 'Voice Integration',
    description: 'Advanced audio processing with natural language understanding.',
  },
];
            ...
            return (
              <div key={index} className="flex gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground/30">{feature.description}</p>
                </div>
              </div>
            );
          })}
