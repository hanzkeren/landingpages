...
const LIST: Array<Item> = [
  ...
  },
  {
    ...
    summary: 'Organize and manage your uploaded files with ease. Access them anytime, anywhere.',
    images: [
      {
          ...
          <div className="aspect-[1.645714286] w-[25rem]">
            <div className="flex size-full items-center -space-x-[10%]">
              <div className="w-full shrink-0">
                <AspectRatio className="overflow-hidden rounded-2xl" ratio={1.558095238}>
                  <img
                    src={images[0].src}
                    alt={images[0].alt}
              ...
              <div className="w-[16%] shrink-0">
                <AspectRatio className="w-full overflow-hidden rounded-lg shadow" ratio={1}>
        ...
        <div className="right-1/6 absolute -bottom-[5%]">
          <div className="relative aspect-[1.195592287] w-[21.25rem] sm:w-[25rem]">
            ...
            <div className="bg-background absolute right-0 top-0 flex aspect-square w-[20%] translate-x-1/2 overflow-hidden rounded-lg shadow">
              {Icon && <Icon className="stroke-muted-foreground/80 m-auto size-[65%] stroke-1" />}
            </div>
          </div>
        </div>
      );
