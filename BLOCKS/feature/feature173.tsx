      ...
      <div className="container">
        <div className="flex gap-3 max-md:flex-col">
          ...
          <p className="flex-1 self-end text-lg font-medium text-muted-foreground">
            Streamline is built on the habits that make the best product teams successful: staying
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 md:mt-12 lg:mt-20 lg:grid-cols-3">
          {ITEMS.map((metric, i) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="text-6xl font-semibold tracking-tight">{metric.value}</div>
                <div className="text-xl font-semibold tracking-tight">{metric.label}</div>
              </div>
            </div>
          ))}
        </div>
