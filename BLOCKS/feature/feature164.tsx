          ...
          <div className="flex flex-col items-end justify-center p-3 lg:w-1/2">
            <div className="max-w-md">
              <h1 className="mb-4 text-3xl font-semibold sm:text-5xl">
                <span className="text-muted-foreground/50">Real-time data.</span> Dynamic reporting.
              </h1>
              <p className="mb-6 text-xl">
                Quickly create reports to get deeper insights into your data with Attio’s powerful
                reporting suite.
              </p>
