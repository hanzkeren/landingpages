...
const FEATURES: FeatureItem[] = [
  ...
  },
  {
    id: 'translation',
    title: 'Translation',
    description: 'Take your content to new markets with blazing-fast AI translation.',
  ...
  },
  {
    ...
    description: 'Instantly cut all your "ums," "uhs" and other filler words. You\'ll save hours.',
  ...
  },
  {
    id: 'captions',
    title: 'Captions',
    description: 'Add captions — and accessibility, and views, and pizazz — in a couple clicks.',
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <p className="max-w-[700px] text-muted-foreground md:text-xl/relaxed">
            Descript's AI editorial assistant tackles the tedium and leaves the creative stuff to
            you.
          </p>
        </div>
