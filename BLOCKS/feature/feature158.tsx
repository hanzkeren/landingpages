    ...
    <section className="py-32">
      <div className="container">
        <div className="mb-12 flex flex-col items-center">
          <h4 className="mb-4 text-muted-foreground/50">Welcome to FinTech Innovations</h4>
          <h1 className="mb-6 text-center text-4xl font-semibold sm:text-5xl lg:text-[56px]">
            Transforming Finance for Everyone
          </h1>
          <h3 className="text-center text-xl">
            Discover how our solutions empower individuals and businesses to manage their finances
            effectively.
          </h3>
        </div>
