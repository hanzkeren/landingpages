      ...
      <div className="container py-32">
        <div className="mb-16 max-w-2xl space-y-8 pl-4">
          ...
          <p className="text-lg tracking-tight text-muted-foreground md:text-xl">
            Discover the powerful features that help transform your workflow and drive business
            success.
          </p>
        </div>
        ...
        >
          ...
          <div className="my-3 flex justify-end gap-3 pr-5">
            ...
            <CarouselNext variant="default" className="static size-12 translate-y-0" />
          </div>
        </Carousel>
      </div>
    </section>
