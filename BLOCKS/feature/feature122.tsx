    ...
    <section className="container py-40">
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3 md:grid-rows-3">
        <DataBlock
          ...
          icon={
            <MessageCircleMore className="size-10 text-primary/90 md:size-12" strokeWidth={1.5} />
          }
        />
        <DataBlock
          title="Integrations"
          description="Lorem ipsum dolor sit amet, consectetur adipisicing elit."
          icon={<Blocks className="size-10 text-primary/90 md:size-12" strokeWidth={1.5} />}
        />
        <DataBlock
          title="Collaboration"
          description="Lorem ipsum dolor sit amet, consectetur adipisicing elit."
        ...
        <DataBlock
          title="Customization"
          description="Lorem ipsum dolor sit amet, consectetur adipisicing elit."
          icon={<LayoutPanelTop className="size-10 text-primary/90 md:size-12" strokeWidth={1.5} />}
        />
        <DataBlock
          title="Security"
          description="Lorem ipsum dolor sit amet, consectetur adipisicing elit."
          icon={<Fingerprint className="size-10 text-primary/90 md:size-12" strokeWidth={1.5} />}
        />
