import { ArrowUpRight, AudioLines, Box, Fingerprint, LocateFixed } from 'lucide-react';
...
const teamFeatures = [
  ...
  },
  {
    id: 2,
    icon: AudioLines,
    title: 'Collaborative Innovation Driving technological breakthroughs breakthroughs ',
  ...
  },
  {
    id: 3,
    icon: Box,
    title: 'Agile Development Rapid iteration and continuous improvement improvement',
  ...
  },
  {
    id: 4,
    icon: Fingerprint,
    title: 'Cross-Functional Excellence Breaking down silos, fostering innovation',
                ...
                <Card className="rounded-none! border-border bg-background hover:bg-linear-to-l hover:to-muted group relative border p-6 shadow-none transition-all duration-500 ease-in-out hover:from-transparent">
                  <CardContent className="flex h-full flex-col justify-between p-0">
                    <div className="size-15 border-border bg-muted group-hover:bg-background flex items-center justify-center border transition-colors duration-500 ease-in-out ">
                      <Icon size={30} className="transition-all duration-500 ease-in-out" />
                    </div>
