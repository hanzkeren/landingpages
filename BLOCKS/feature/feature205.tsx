import { ScrollableTabsList } from '#app/components/shadcnblocks/scrollable-tabslist';
        ...
        >
          <div className="flex flex-col-reverse justify-between gap-8 lg:flex-col">
            <div>
              ...
              >
                <span className="text-muted-foreground text-xs uppercase">Efficiency</span>
                <div className="flex flex-col gap-4">
                  <h2 className="text-3xl font-medium">Streamline. Automate. Focus.</h2>
                  <p className="text-muted-foreground">
                    Our AI-powered workspace eliminates repetitive tasks and centralizes your
                    workflow. Spend time on what matters.
                  </p>
                </div>
              </TabsContent>
              <TabsContent
                ...
                className="animate-in fade-in flex flex-col gap-6 duration-300"
              >
                <span className="text-muted-foreground text-xs uppercase">Collaboration</span>
                <div className="flex flex-col gap-4">
                  <h2 className="text-3xl font-medium">Connect. Create. Collaborate.</h2>
                  <p className="text-muted-foreground">
                    Real-time editing and seamless sharing keep your team in sync. Communication
                    tools built right into your workspace.
                  </p>
                </div>
              </TabsContent>
              <TabsContent
                ...
                className="animate-in fade-in flex flex-col gap-6 duration-300"
              >
                <span className="text-muted-foreground text-xs uppercase">Insights</span>
                <div className="flex flex-col gap-4">
                  <h2 className="text-3xl font-medium">Track. Analyze. Optimize.</h2>
                  <p className="text-muted-foreground">
                    Our analytics dashboard visualizes productivity patterns and identifies
            ...
            <ScrollableTabsList>
              <TabsList className="mx-auto h-12 rounded-full p-2 lg:mx-0">
                <TabsTrigger value="efficiency" className="h-full rounded-full px-4 py-2">
                  Efficiency
                </TabsTrigger>
                <TabsTrigger value="collaboration" className="h-full rounded-full px-4 py-2">
                  Collaboration
                </TabsTrigger>
                <TabsTrigger value="insights" className="h-full rounded-full px-4 py-2">
                  Insights
                </TabsTrigger>
              </TabsList>
          ...
          <div>
            <TabsContent value="efficiency" className="animate-in fade-in duration-300">
            ...
            <TabsContent value="collaboration" className="animate-in fade-in duration-300">
              <div className="relative">
                <img
