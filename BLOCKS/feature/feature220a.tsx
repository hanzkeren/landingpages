      ...
      <div className="container max-w-5xl">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto mb-8 max-w-3xl text-xl font-medium leading-relaxed">
            Transform your development process with pre-built components that adapt to your design
            system and accelerate your time-to-market.
          </p>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            {stats.map((item, i) => (
              <div className="text-center" key={`stats-${i}`}>
                <div className="text-primary mb-2 text-4xl font-bold">{item.number}</div>
