...
import { Blocks, Infinity as InfinityIcon, Laptop, ListEnd, Zap, ZoomIn } from 'lucide-react';
...
const items = [
  ...
  },
  {
    ...
    description: 'Our UI blocks are fully responsive and look great on any device',
  },
  {
    icon: <ListEnd className="size-6" />,
    description: 'Our UI blocks are easy to use and require no coding knowledge',
  },
  {
    ...
    <section className="container py-32">
      <div className="bg-muted m-auto rounded-3xl px-8 pb-8 pt-14 text-center md:px-16 md:pb-16 md:pt-24">
        <h2 className="mx-auto mb-4 max-w-96 text-3xl font-normal md:max-w-xl md:text-5xl">
          Build your own website with our <span className="italic">UI blocks</span>
        </h2>
        <p className="mx-auto max-w-xl text-sm font-normal">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nesciunt, accusantium quam.
          Temporibus quae quos deserunt!
        </p>
