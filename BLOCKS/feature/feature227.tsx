        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mb-12 text-lg text-muted-foreground">
              Unleash your creativity and break through barriers. Our platform brings all your ideas
              together in one intuitive workspace. Eliminate creative blocks and empower your team
              to imagine, design, and deliver.
            </p>
