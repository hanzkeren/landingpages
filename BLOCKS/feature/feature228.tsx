        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-0">
          <div className="lg:pr-16">
            ...
            <p className="text-lg text-muted-foreground">
              Transform your living space with intelligent technology that adapts to your lifestyle
              and enhances your daily experiences.
            </p>
            <div className="mt-12 grid gap-8 sm:grid-cols-2 sm:gap-10">
              <div>
                ...
                <h3 className="mb-2.5 text-sm font-semibold">Intelligent Lighting</h3>
                <p className="text-sm text-muted-foreground">
                  Control brightness, color, and schedules with smart lighting that responds to your
                  routines and saves energy.
                </p>
              </div>
              <div>
                <span className="mb-4 grid size-12 place-items-center rounded-lg bg-muted-foreground/10">
                ...
                <h3 className="mb-2.5 text-sm font-semibold">Advanced Security</h3>
                <p className="text-sm text-muted-foreground">
                  Monitor your home from anywhere with smart cameras, sensors, and alerts that keep
              ...
              <div>
                ...
                <h3 className="mb-2.5 text-sm font-semibold">Ecosystem Integration</h3>
                <p className="text-sm text-muted-foreground">
                  Seamlessly connect with Apple and Google ecosystems for a unified experience
              ...
              <div>
                ...
                <h3 className="mb-2.5 text-sm font-semibold">Social Connectivity</h3>
                <p className="text-sm text-muted-foreground">
                  Share your content instantly across major social platforms including X and
                  Facebook with one-click publishing.
                </p>
              </div>
            </div>
          </div>
