...
const DATA: DataItem[] = [
  {
    ...
    description: 'Streamline your operations with tools designed to fit your business needs.',
    icon: <Workflow />,
    className: 'absolute cursor-pointer top-0.5',
  },
  {
    title: 'Eliminate Clunky Tools',
    description: 'Replace outdated software with intuitive solutions that empower your team.',
    icon: <Wrench />,
    className: 'absolute cursor-pointer -right-4 top-5 xl:top-0 xl:right-5',
  },
  {
    title: 'Connect Your Workflows',
    description: 'Integrate your tools and data to create seamless, efficient workflows.',
    icon: <Cable />,
