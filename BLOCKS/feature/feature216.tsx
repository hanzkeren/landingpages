...
const TabLabel = ({ value }: TabLabelProps) => {
  ...
  return (
    <div className="mb-8 flex items-center justify-center gap-6 xl:hidden">
      <div className="flex size-8 rounded-md" style={{ backgroundColor: label.color }}>
      ...
      <div className="px-5 sm:px-6 2xl:px-16">
        <div className="w-full rounded-2xl bg-muted pt-10 pb-20 sm:pt-12 sm:pb-24">
          <div className="container">
            <Tabs value={tabValue} onValueChange={onValueChange} className="w-full">
              <TabsList className="hidden h-fit w-full items-end gap-12 bg-transparent pt-12 pb-16 xl:flex">
                {TAB_TRIGGERS.map((trigger, index) => (
                  ...
                  >
                    ...
                    <div className="text-xl font-normal text-black">{trigger.name}</div>
                  </TabsTrigger>
                ))}
              </TabsList>
              <div className="relative">
                {TABS.map((tab) => (
                  ...
                  >
                    ...
                    <div className="sm:px-8k mt-10 w-full sm:mt-14 xl:mt-20" ref={imageRef}>
                      <AspectRatio
                        ratio={1.847058824}
                ...
                <div className="absolute left-0 translate-y-1/2" style={{ bottom: buttonPosition }}>
                  <Button
                    variant="secondary"
