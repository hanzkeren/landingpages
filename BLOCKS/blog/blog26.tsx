...
const POSTS: Array<post> = [
  {
    title: 'AI for Marketers: The Latest Tools of the Trade and How to Master Them',
    link: '#',
    author: {
      name: 'Christian Buehner',
      link: '#',
        ...
        <div className="mb-10 grid grid-cols-[minmax(18.75rem,1fr)] items-start justify-start gap-2.5 md:mb-20 lg:mb-24 lg:grid-cols-[minmax(18.75rem,1fr)_minmax(12.5rem,28.125rem)] lg:gap-20">
          ...
          <div className="pb-5">
            <p className="text-foreground text-base sm:text-lg">
              <span className="text-muted-foreground">Inspiration meets innovation</span>
              <br />
            ...
            <div className="mt-6 rounded-lg border p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">Content Writer</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid w-full grid-cols-[minmax(18.75rem,1fr)] gap-20 pb-[6.25rem] lg:grid-cols-[minmax(18.75rem,1fr)_minmax(12.5rem,28.125rem)]">
          <div>
            <div className="flex flex-col gap-[1.875rem]">
              ...
              >
                <AspectRatio ratio={1.736111111} className="m-auto overflow-hidden">
                  <img
              ...
              <div className="flex w-full flex-col gap-5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground text-sm">•</span>
                  <span className="text-muted-foreground text-sm">{TOP_POST.date}</span>
                </div>
              </div>
            </div>
          </div>
