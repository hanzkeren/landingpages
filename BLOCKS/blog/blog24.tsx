    ...
    <section className="py-32">
      <div className="container mx-auto">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-12 text-muted-foreground md:text-base lg:text-lg">{description}</p>
        </div>

        <div className="mx-auto max-w-5xl space-y-12">
          {posts.map((post) => (
            <Card key={post.id} className="overflow-hidden border-0 bg-transparent shadow-none">
