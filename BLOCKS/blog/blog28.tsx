  ...
  return (
    <section className="py-32">
      <div className="container">
        <h1 className="mb-12 text-center text-4xl font-medium md:text-7xl">Latest Tech Blog</h1>
        ...
        <div className="xs:grid-cols-1 mt-24 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="relative md:row-span-2 lg:col-span-2">
            <a href={posts[0].link} className="block h-fit rounded-lg p-3 md:top-0">
              <img
                src={posts[0].image}
                alt={posts[0].title}
              ...
              <div className="mt-5">
                ...
                <h3 className="text-lg md:text-3xl lg:text-4xl">{posts[0].title}</h3>
                <p className="mt-4 text-muted-foreground">{posts[0].description}</p>
              </div>
            </a>
          </div>
