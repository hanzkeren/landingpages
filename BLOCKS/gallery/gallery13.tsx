...
const DATA: DataItem[] = [
  {
    ...
    description: 'Discover our beautifully crafted designs that blend style and functionality.',
    icon: Palette,
  },
  {
  ...
  },
  {
    ...
    description: 'Stay ahead of the curve with our contemporary and trendy collections.',
    icon: Sparkles,
  },
];
            ...
            <div className="md:col-span-2">
              <div className="bg-muted flex h-full flex-col gap-8 rounded-lg px-8 py-16">
                ...
                <div className="flex flex-col gap-4">
                  <h2 className="text-3xl font-medium">{DATA[activeIndex].title}</h2>
