...
import { DirectionAwareHover } from '#app/components/aceternity/direction-aware-hover';
    ...
    <section className="relative h-full w-screen overflow-hidden py-32">
      <div className="container relative flex h-full w-full flex-col items-center justify-center">
        <div className="relative z-10 flex flex-col items-center justify-center gap-5">
          <p className="bg-muted rounded-full px-2 py-1 text-xs uppercase">CATALOG</p>
          <h1 className="font-calSans text-center text-6xl font-medium">Exclusive shadcnblocks</h1>
        ...
        <div className="relative mt-[34px] grid w-full max-w-5xl grid-cols-1 justify-center gap-[10px] md:grid-cols-2 lg:grid-cols-4">
          {featureData.map((item, index) => (
            <DirectionAwareHover key={index} className={item.imgClass} imageUrl={item.imgsrc}>
