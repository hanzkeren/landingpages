...
import { Lens } from '#app/components/aceternity/lens';
      ...
      <div className="container w-full">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {cardData.map((card, index) => (
            <div key={index} className="bg-muted/60 rounded-4xl relative flex flex-col p-2">
              <Lens
              ...
              <div className="mt-3 flex items-center justify-between gap-3 px-2 pb-3">
                <div>
                  <p className="text-muted-foreground text-sm tracking-tighter">{card.title}</p>
