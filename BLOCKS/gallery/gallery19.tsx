                  ...
                  <SwiperSlide key={index}>
                    ...
                    <div className="absolute flex h-full w-full flex-col justify-end p-4">
                      <h3 className="text-2xl font-bold text-white">
                        {image.name.split(' ')[0]}
                        <span className="font-playfair italic"> {image.name.split(' ')[1]}</span>
                      </h3>
                      <p className="text-left text-xs text-white/50">{image.description}</p>
                      <Button
                        variant="secondary"
                      ...
                      >
                        <a href={image.link}>
                          Know More <ArrowRight size={14} className="-rotate-45" />
                        </a>
                      </Button>
                    </div>
                  </SwiperSlide>
