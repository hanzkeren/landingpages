          ...
          <div className="flex flex-col justify-between lg:h-[460px] lg:w-[445px] lg:pr-10">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-lg">
                From startups to enterprises, we empower businesses with cutting-edge software
                solutions. Hear from our satisfied clients.
              </p>
            </div>
            ...
            >
              <CarouselContent>
                {DATA.map((testimonial) => (
                  <CarouselItem key={testimonial.id} className="min-w-[800px] flex-1">
