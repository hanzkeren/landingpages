...
const CarouselItems = [
  {
    ...
    description: 'Techniques for improving web application speed and user experience.',
    imageSrc:
  ...
  },
  {
    ...
    description: 'Master the art of creating reusable and scalable React components.',
    imageSrc:
                  ...
                  <div className="bg-muted/50 group-hover:bg-muted relative h-full w-full p-4 transition-all ease-in-out">
                    ...
                    <div className="absolute top-4 -ml-4 flex h-full w-full flex-col items-center justify-between p-10">
                      <p className="text-background flex w-full items-center text-xl tracking-tighter">
                        {item.year} <span className="bg-background mx-2 h-2.5 w-[1px]" />
                        {item.month}
                      </p>
                      ...
                      >
                        ...
                        />
                        <p className="text-background text-xl tracking-tight">See All</p>
                      </a>
                    </div>
                  </div>
                </DottedDiv>
