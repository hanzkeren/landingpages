    ...
    <section className="py-32">
      <div className="container">
        ...
        <p className="mt-3 max-w-xl text-muted-foreground">
          ...
          ut labore et dolore magnam veniam, quis nostrud exercitation ullamco laboris nisi ut
          aliqui
        </p>
        <Carousel
          opts={{
        ...
        >
          <div className="absolute top-0 right-0 flex h-12 w-20 items-center justify-end gap-2">
            <CarouselPrevious variant="default" className="absolute left-0 rounded-none" />
            <CarouselNext variant="default" className="absolute right-0 rounded-none" />
          </div>
          <CarouselContent>
