    ...
    <section className="py-32">
      <div className="container">
        <div className="mb-12 grid grid-cols-1 gap-x-12 gap-y-6 md:mb-16 md:grid-cols-2 md:gap-x-24">
          ...
          <p>
            We thrive on the power of AI. Our team is made up of some of the most talented people in
            the world, and we&apos;re looking for new ways to push the boundaries of what&apos;s
            possible. We&apos;re a team of data scientists.
          </p>
