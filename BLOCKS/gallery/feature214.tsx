...
import { AudioLines, Captions, Eye, Languages, ListMinus, ScanFace, TextQuote } from 'lucide-react';
      ...
      <div className="container">
        <div className="mx-auto mb-16 flex max-w-[47.5rem] flex-col gap-6">
          ...
          <p className="text-center text-xl">
            Refine your appearance, improve your audio, and tackle all the obvious, tedious
            edits—instantly with just a few clicks, thanks to your AI editing assistant.
          </p>
        </div>
        <Carousel
          opts={{
