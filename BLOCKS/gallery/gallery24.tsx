      ...
      <div className="relative container overflow-x-clip">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-md my-10 max-w-lg text-center opacity-50">
            we deliver Results Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt.
          </p>

          <div className="flex w-full items-center justify-center gap-1">
            {images.slice(0, useIsMobile() ? 4 : images.length).map((image, index) => (
              <motion.div
                key={image.id}
              ...
              >
                  ...
                  {activeImage === index && (
                    ...
                    >
                      ...
                      <h3 className="w-42 text-right text-3xl font-bold text-white lg:w-fit lg:whitespace-nowrap">
                        {image.title.split(' ')[0]}
                        <span className="font-playfair italic"> {image.title.split(' ')[1]} </span>
                      </h3>
                ...
                <img src={image.src} className="size-full object-cover" alt={image.title} />
              </motion.div>
            ))}
          </div>
