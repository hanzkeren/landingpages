...
const items = [
  {
    ...
    description: (
      <>
        Dive deep into the robust functionalities designed to streamline your workflow. Benefit from
        intuitive design, seamless integration, and powerful customization options.
        <br />
        <br />
        Explore how our platform adapts to your evolving needs, ensuring long-term value and
        efficiency.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <p>Discover how our platform addresses diverse challenges across various domains:</p>
  ...
  },
  {
    ...
    description: (
      <>
        <p>Get a glimpse into our ongoing commitment to innovation and improvement:</p>
        <ul className="my-4 ml-6 list-disc">
        ...
        <p>We're constantly evolving based on user feedback and industry trends.</p>
      </>
    ),
  ...
  return (
    <section className="overflow-hidden py-32">
      <div className="container">
        <Carousel setApi={setApi} className="[&>div[data-slot=carousel-content]]:overflow-visible">
          <div className="flex items-center justify-between">
            <Tabs value={current} onValueChange={setCurrent} className="mb-8 flex justify-center">
              ...
              <CarouselItem key={idx} className="w-fit max-w-4xl">
                <div className="grid h-full max-w-4xl gap-10 rounded-xl border border-border p-6 shadow-sm select-none sm:p-10 md:max-h-[450px] md:grid-cols-2 lg:gap-20">
                  <div className="flex flex-col justify-between gap-4">
                    ...
                    <p className="mt-4 text-xs text-muted-foreground sm:mt-6">{item.note}</p>
                  </div>
