...
import {
  ...
  SnippetTabsList,
  SnippetTabsTrigger,
} from '#app/components/kibo-ui/snippet';
          ...
          <div className="flex flex-1 flex-col gap-4">
            <div>
              <div className="flex flex-col gap-1">
                <h1 className="text-3xl font-medium tracking-tighter">Download Version 2.2.5</h1>
                <time dateTime="2025-08-22" className="text-muted-foreground text-sm">
                  August 22, 2025
                </time>
              </div>
            </div>
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="grid gap-2">
                ...
                <Snippet defaultValue="stable" value={linuxVersion} onValueChange={setLinuxVersion}>
                  <SnippetHeader>
                    <SnippetTabsList>
              ...
              <div className="grid gap-2">
                ...
                <Snippet defaultValue="apple-silicon">
                  ...
                  <TabsContent value="apple-silicon" className="bg-background mt-0 text-sm">
                  ...
                  <TabsContent value="intel" className="bg-background mt-0 text-sm">
                    <button className="hover:bg-accent flex h-[52px] w-full items-center justify-between px-4 text-left transition-colors">
                      <div className="flex flex-col">
                        <p className="font-bold">Download now</p>
                ...
                <p className="text-muted-foreground text-xs">Requires version 10.15 or later</p>
              </div>
              <div className="grid gap-2">
                <div className="flex items-center gap-2">
                  <FaWindows />
