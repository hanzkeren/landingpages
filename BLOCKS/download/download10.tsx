import { FaApple, FaChrome, FaFirefox, FaSafari, FaWindows } from 'react-icons/fa';
    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          <h1 className="text-5xl font-semibold md:text-7xl">Get Started Today</h1>
          <p className="text-muted-foreground max-w-2xl text-lg md:text-xl">
            Transform your workflow with powerful tools designed to boost productivity, streamline
            collaboration, and help you achieve your goals faster than ever before.
          </p>
        </div>
        <div className="mx-auto mt-20 grid max-w-5xl grid-cols-1 place-items-center gap-6 lg:grid-cols-3">
          ...
          <div className="border-border flex h-full w-full max-w-md flex-col justify-between gap-6 rounded-xl border p-8">
            ...
            <div className="flex justify-center gap-2">
              <Button variant="outline" size="lg" className="h-19 w-20 flex-col p-3">
