        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-muted-foreground max-w-md">
              Create stunning designs, collaborate seamlessly, and bring your ideas to life on any
              device. Start designing in seconds with our intuitive design platform.
            </p>
