    ...
    <section className="bg-muted/50 py-32">
      <div className="container">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="text-muted-foreground mx-auto mb-12 max-w-2xl text-lg">{description}</p>
        </div>
        ...
        <div className="mx-auto grid max-w-4xl gap-12 md:grid-cols-3">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 text-sm">{platforms.desktop?.description}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 text-sm">{platforms.ios?.description}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 text-sm">{platforms.android?.description}</p>
