...
const Download1 = ({
  ...
  platforms = {
    desktop: {
      title: 'Desktop',
      subtitle: 'PC/Mac',
      description: 'Unlock the full potential with our comprehensive desktop version.',
      buttonText: 'Download',
      url: '#',
    },
    ios: {
    ...
    <section className="bg-muted/30 py-32">
      <div className="container">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-lg">{description}</p>
        </div>
        ...
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-3">
          ...
          <Card className="bg-muted text-foreground flex flex-col border-0 p-6">
            ...
            <div className="mb-4 flex-1">
              ...
              <h3 className="mb-3 text-2xl font-bold">{platforms.desktop?.subtitle}</h3>
              <p className="text-sm leading-relaxed">{platforms.desktop?.description}</p>
            </div>
            <div>
          ...
          <Card className="bg-background border-border flex flex-col p-6">
            ...
            <div className="mb-6 flex-1">
              <p className="text-muted-foreground mb-1 text-sm">{platforms.ios?.title}</p>
              <h3 className="mb-3 text-2xl font-bold">{platforms.ios?.subtitle}</h3>
          ...
          <Card className="bg-background border-border flex flex-col p-6">
            ...
            <div className="mb-6 flex-1">
              <p className="text-muted-foreground mb-1 text-sm">{platforms.android?.title}</p>
              <h3 className="mb-3 text-2xl font-bold">{platforms.android?.subtitle}</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
