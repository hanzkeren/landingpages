...
import { GlareCard } from '#app/components/aceternity/glare-card';
    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col items-center justify-center gap-11">
          ...
          <h1 className="text-4xl font-semibold sm:text-5xl">Shadcnblocks.com</h1>
        </div>
        <div className="mt-11 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-muted-foreground text-sm">Last updated September 23, 2025</p>
        </div>
        <div className="mt-8">
