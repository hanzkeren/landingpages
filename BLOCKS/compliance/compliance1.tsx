        ...
        <div className="grid gap-9 lg:grid-cols-2">
          <div className="flex flex-col gap-5">
            ...
            <p className="text-muted-foreground text-lg">
              Stay compliant with privacy and healthcare regulations. Our platform meets GDPR and
              HIPAA requirements, providing data protection and compliance monitoring for regulated
              industries.
            </p>
          ...
          <div className="border-border bg-background rounded-2xl border">
            <div className="border-border relative overflow-hidden border-b p-6 lg:px-8 lg:py-11">
              <div>
                ...
                <p className="text-muted-foreground mt-2 w-3/4 pr-10 text-sm md:text-base">
                  Every action is logged and timestamped with immutable audit trails for complete
            ...
            <div className="relative overflow-hidden p-6 lg:px-8 lg:py-11">
              <div>
                ...
                <p className="text-muted-foreground mt-2 w-3/4 pr-10 text-sm md:text-base">
                  Real-time monitoring ensures continuous compliance with industry standards and
                  regulations.
                </p>
              </div>
              <img
            ...
            <div className="border-border relative overflow-hidden border-t p-6 lg:px-8 lg:py-11">
              <div>
                ...
                <p className="text-muted-foreground mt-2 w-3/4 pr-10 text-sm md:text-base">
                  Generate compliance reports automatically to meet regulatory requirements and
                  audit demands.
                </p>
              </div>
              <img
