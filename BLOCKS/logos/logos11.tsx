    ...
    <section className="relative grid w-screen overflow-hidden py-32">
      <div className="container relative z-10 h-full items-center justify-center gap-6">
        ...
        <div className="relative flex h-20 w-full items-center justify-center border border-x-0">
          ...
          <Button variant="ghost" className="flex h-12 items-center gap-3 rounded-none !px-8">
            <PlayIcon />
            How it works
          </Button>
...
const BgPattern = ({ sideLines = true }: { sideLines?: boolean }) => {
  return (
    <>
      ...
      {/* bg Lines left */}
      {sideLines && <div className="absolute left-0 z-10 h-[200vh] w-px border-l" />}
      {sideLines && <div className="absolute -left-20 z-10 h-[200vh] w-px border-l" />}

      {/* bg Lines right */}
      {sideLines && <div className="absolute right-0 z-10 h-[200vh] w-px border-l" />}
      {sideLines && <div className="absolute -right-20 z-10 h-[200vh] w-px border-l" />}
    </>
  );
};
