        ...
        <div className="mx-auto flex flex-col items-center justify-center text-center sm:max-w-xl">
          <div className="flex flex-col items-center">
            ...
            <p className="font-mono text-muted-foreground">
              Connect your existing tools and platforms seamlessly. Our system automatically syncs
              and manages your data across all integrated services.
            </p>
          </div>
          <span
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-mono text-muted-foreground">
              Tailor the platform to your needs with our intuitive interface. Create powerful
              workflows without any technical knowledge required.
            </p>
          </div>
          <span
            className="my-3 h-36 w-[2px]"
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-mono text-muted-foreground">
              Access comprehensive analytics and tools designed to help you grow. Monitor
              performance and make data-driven decisions effortlessly.
            </p>
          </div>
        </div>
      </div>
