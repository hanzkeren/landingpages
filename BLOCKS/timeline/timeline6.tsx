...
const DATA: DataItem[] = [
  ...
  },
  {
    ...
    description: 'Automate repetitive tasks to reduce human error and ensure consistent results.',
  },
  {
  ...
  },
  {
    ...
    title: 'Save Time',
    description: 'Focus on what matters most by automating time-consuming tasks and processes.',
  },
];
