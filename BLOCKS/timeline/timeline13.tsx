    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col">
          <h1 className="mb-2 text-3xl font-semibold md:text-5xl">Journey to Product Launch</h1>
          <p className="text-muted-foreground max-w-2xl">
            Follow the essential steps to bring your innovative idea to market and ensure a
          ...
          <div className="mt-3 flex gap-4 sm:flex-col">
            ...
            <div className="grid gap-10 sm:grid-cols-3">
              <div className="flex h-full flex-col justify-between gap-4">
                <div className="flex flex-col">
                  <div className="bg-border border-border flex h-8 w-fit items-center gap-px overflow-hidden rounded-md border text-sm font-medium">
                    <span className="bg-background grid h-full place-items-center px-2">01</span>
                    <span className="bg-background grid h-full place-items-center px-2">
                      Ideation
                    </span>
                  </div>
                  <h3 className="mt-5 font-medium">Brainstorm and validate your concept</h3>
                  <p className="text-muted-foreground mt-2 text-sm">
                    Gather insights from market research, customer interviews, and competitor
                    analysis to refine your product idea.
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <Progress value={15} className="h-1 flex-1" />
                    <span className="text-muted-foreground w-8 text-right text-xs">15%</span>
                  </div>
              ...
              <div className="flex h-full flex-col justify-between gap-4">
                <div className="flex flex-col">
                  <div className="bg-border border-border flex h-8 w-fit items-center gap-px overflow-hidden rounded-md border text-sm font-medium">
                    <span className="bg-background grid h-full place-items-center px-2">02</span>
                    <span className="bg-background grid h-full place-items-center px-2">
                      Development
                    </span>
                  </div>
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    Design, prototype, and develop the minimum viable product. Iterate quickly based
                    on early feedback and testing.
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <Progress value={85} className="h-1 flex-1" />
                    <span className="text-muted-foreground w-8 text-right text-xs">85%</span>
                  </div>
              ...
              <div className="flex h-full flex-col justify-between gap-4">
                <div className="flex flex-col">
                  <div className="bg-border border-border flex h-8 w-fit items-center gap-px overflow-hidden rounded-md border text-sm font-medium">
                    <span className="bg-background grid h-full place-items-center px-2">03</span>
                    <span className="bg-background grid h-full place-items-center px-2">
                      Launch
                    </span>
                  </div>
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    Execute your launch plan with marketing campaigns, outreach, and customer
                    support to maximize impact and adoption.
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <Progress value={100} className="h-1 flex-1" />
                    <span className="text-muted-foreground w-8 text-right text-xs">100%</span>
                  </div>
                  <p className="text-muted-foreground mt-1 text-xs">Launch complete</p>
                </div>
              </div>
            </div>
          </div>
