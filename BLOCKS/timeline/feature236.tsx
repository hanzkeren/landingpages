    ...
    <section className="bg-background py-32">
      <div className="container flex flex-col items-center gap-10 md:gap-0">
        ...
        <div className="flex gap-4 sm:mt-8">
          <Button className="h-11 w-full rounded-xl sm:w-auto">Discover all components</Button>
...
const BracketedBorder = ({ children }: { children: ReactNode }) => (
  ...
  >
    <div className="absolute inset-0 hidden border border-foreground/10 md:block">
      <ShineBorder duration={10} borderWidth={2} shineColor={['oklch(87.1% 0.15 154.449)']} />
    ...
    <div className="flex h-full w-screen flex-col items-center justify-center">{children}</div>
  </motion.div>
);
