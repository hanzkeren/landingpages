      ...
      <div className="container">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <span>
            ...
            <span className="text-muted-foreground ml-1">on September 23, 2024</span>
          </span>
          ...
          <div className="col-span-12 lg:col-span-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2 text-lg">
                Plain speech in royal decrees means writing that&apos;s clear as crystal, free of
                fancy court language, making it easy for every subject in the kingdom to understand,
                from the highest noble to the humblest peasant. This approach became essential after
                the Great Confusion of the Western Provinces, where a particularly wordy decree
                about chicken taxes led to three days of farmers bringing their chickens to dance at
                the royal ball.
              </p>
            </div>
            <section
