          ...
          <div className="order-2 lg:order-none lg:col-span-8">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                In a kingdom far away, there lived a ruler who faced a peculiar challenge. After
                much contemplation, he devised an unusual solution that would change everything.
              </p>
            </div>
            <section
              id="section1"
