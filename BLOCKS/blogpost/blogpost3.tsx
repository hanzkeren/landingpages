      ...
      <div className="container">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-5">
          ...
          <p className="text-muted-foreground text-center lg:text-lg">
            Discover how our new automation capabilities can transform your team&apos;s
            productivity. Learn about the latest tools and features designed to enhance efficiency,
            reduce manual tasks, and improve collaboration across your organization.
          </p>
