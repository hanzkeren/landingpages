          ...
          <CardContent className="lg:px-18 relative overflow-hidden py-12 lg:py-24">
            <div className="grid grid-cols-1 items-end gap-8 md:grid-cols-2">
              <div className="flex flex-col justify-center space-y-6">
                ...
                <h1 className="text-foreground text-5xl font-bold tracking-tighter">Contact Us</h1>

                <ul className="max-w-lg space-y-2 tracking-tight">
                  <li className="flex items-center">
                    <span className="mr-2 font-bold">Email:</span>{' '}
                    <span className="text-foreground/80 underline">example@shadcnblocks.com</span>
                  </li>
                  <li className="flex items-center">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-foreground/80">123 Design Street, UI City</span>
                  </li>
                  <li className="flex items-center">
                    <span className="mr-2 font-bold">Hours:</span>{' '}
                    <span className="text-foreground/80">Mon-Fri, 9am-5pm EST</span>
                  </li>
                </ul>
              </div>
