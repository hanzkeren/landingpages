    ...
    <section className="py-32">
      <div className="container">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground">Find the right solution</p>
        </div>
          ...
          <div className="flex flex-col gap-2 rounded-lg bg-accent p-2">
            ...
            <div className="flex h-full flex-col justify-between gap-6 rounded-md bg-background p-6">
              ...
              <div className="grid gap-8 md:grid-cols-2 md:gap-4">
                <div>
                  <p className="mb-2 text-xl text-muted-foreground md:mb-4">New York</p>
                  <p>123 6th St. Melbourne, FL 32904, USA</p>
                </div>
                <div>
                  <p className="mb-2 text-xl text-muted-foreground md:mb-4">London</p>
