  ...
  const services = [
    {
      ...
      items: ['Market Research', 'User Personas', 'Competitive Analysis', 'Product Roadmaps'],
      deliverables: ['Strategy Document', 'User Persona Profiles', 'Market Analysis Report'],
    },
    {
      ...
      items: ['UI/UX Design', 'Prototyping', 'Interaction Design', 'Design Systems'],
      deliverables: ['Design System', 'Interactive Prototypes', 'UI/UX Mockups'],
    },
    {
      ...
      items: ['Frontend Dev', 'Backend Dev', 'API Integration', 'Performance Optimization'],
    ...
    },
    {
      ...
      items: ['SEO Strategy', 'Analytics & Data', 'A/B Testing', 'Content Marketing'],
      deliverables: ['Marketing Plan', 'Analytics Setup', 'Performance Reports'],
    },
  ];
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        {service.deliverables.map((deliverable, delivIndex) => (
                          <li key={delivIndex} className="flex items-center gap-2 text-sm">
                            <div className="bg-foreground h-1 w-1 rounded-full" />
                            {deliverable}
                          </li>
                        ))}
