        ...
        <div className="flex flex-col justify-between lg:col-span-1">
          <div>
            ...
            <p className="text-muted-foreground w-72 text-base tracking-tight">
              We offer comprehensive digital solutions to help your business grow. From web
              development to mobile apps, we deliver quality results that exceed expectations.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2">
          ...
          >
            <Card className="relative aspect-[4/5] overflow-hidden p-0">
              ...
              <CardContent className="absolute inset-0 flex flex-col justify-end p-6">
                <div className="pr-4 text-lg font-semibold text-white">{services[1].title}</div>
              </CardContent>
          ...
          >
            <Card className="relative aspect-[4/5] overflow-hidden p-0">
              ...
              />
              <CardContent className="absolute inset-0 flex flex-col justify-end p-6">
                <div className="pr-4 text-lg font-semibold text-white">{services[2].title}</div>
              </CardContent>
              <ArrowUpRight className="absolute right-6 top-6 h-6 w-6 text-white transition-transform group-hover:scale-110" />
            </Card>
          </motion.a>
          ...
          >
            <Card className="relative aspect-[4/5] overflow-hidden p-0">
              ...
              />
              <CardContent className="absolute inset-0 flex flex-col justify-end p-6">
                <div className="pr-4 text-lg font-semibold text-white">{services[3].title}</div>
              </CardContent>
              <ArrowUpRight className="absolute right-6 top-6 h-6 w-6 text-white transition-transform group-hover:scale-110" />
            </Card>
          </motion.a>
          ...
          >
            <Card className="relative aspect-[4/5] overflow-hidden p-0">
              ...
              />
              <CardContent className="absolute inset-0 flex flex-col justify-end p-6">
                <div className="pr-4 text-lg font-semibold text-white">{services[4].title}</div>
              </CardContent>
              <ArrowUpRight className="absolute right-6 top-6 h-6 w-6 text-white transition-transform group-hover:scale-110" />
            </Card>
          </motion.a>
