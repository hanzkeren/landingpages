...
const Services1 = () => {
  const services = [
    ...
    },
    {
      ...
      items: ['Market Entry Strategies', 'Partnership Development', 'Mergers and Acquisitions'],
    },
    {
      title: 'Monitoring',
      description:
        'We provide the tools and insights needed to monitor and enhance every facet of your business operations.',
      items: ['Real-time Analytics', 'Performance Metrics Tracking', 'Risk Management Solutions'],
    },
  ];
    ...
    <section className="bg-background py-32">
      <div className="container">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-foreground mb-4 text-xl font-semibold">Services</h2>

          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            {services.map((service, index) => (
              <div key={index} className="bg-muted rounded-lg p-8">
                <h3 className="text-foreground mb-4 text-base font-medium">{service.title}</h3>
