      ...
      <div className="container">
        <div className="mb-16 max-w-2xl">
          ...
          <p className="text-muted-foreground text-base tracking-tight">
            Transform your business with our comprehensive digital services. We combine creativity
            with technical expertise to deliver solutions that drive growth.
          </p>
        </div>
        ...
        <div className="columns-1 gap-6 sm:columns-2 lg:columns-3">
          {services.map((service, idx) => (
            ...
            >
              <Card className={`relative ${getHeightClass(service.height)} overflow-hidden p-0`}>
                <img
                  src={service.image}
                  alt={service.title}
