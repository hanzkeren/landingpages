...
import { ArrowRight, CheckCircle, Code, Cog, PenTool, Shrub } from 'lucide-react';
...
const Services10 = () => {
  const services = [
    ...
    },
    {
      ...
      deliverables: ['Source Code', 'Technical Documentation', 'Deployment Guide'],
      duration: '6-12 weeks',
      ...
      <div className="container">
        <div className="mx-auto max-w-6xl space-y-16">
          ...
          <div className="bg-background rounded-xl border p-8 text-center">
            <h3 className="mb-2 text-xl font-semibold">Need a custom solution?</h3>
            <p className="text-muted-foreground mb-6">
              We offer tailored packages combining multiple services for comprehensive digital
              transformation.
            </p>
            <Button size="lg" className="from-primary to-primary/80 bg-gradient-to-r">
