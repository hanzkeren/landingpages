            ...
            <div className="relative space-y-20">
              ...
              <div className="relative">
                ...
                <div className="my-4 flex items-center gap-2">
                  ...
                  <time className="text-muted-foreground text-sm">11 Feb 2025</time>
                </div>
                <div className="prose dark:prose-invert max-w-none">
                  <h2 className="text-4xl">Big Tech Stack Updates and Performance Boost</h2>
                  <p>
                    We&apos;re upgrading our tech stack to leverage{' '}
                    <b>cutting-edge web technologies</b>, providing better performance and developer
                    experience across our platform.
                  </p>
                  <h3>Framework updates:</h3>
                  <ul>
                    <li>
                      <b>React 18</b> - Concurrent rendering and automatic batching for better
                      performance.
                    </li>
                    <li>
                      <b>TypeScript 5.0</b> - Better type inference and decorator support.
                    </li>
                    <li>
                      <b>Vite 5.0</b> - Lightning fast builds and improved hot module replacement.
                    </li>
                  </ul>
                  <p>
                  ...
                  <ul>
                    <li>
                      <b>Lazy loading</b> - Reduced initial load time and improved user experience.
                    </li>
                    <li>
                      <b>Code splitting</b> - Improved code organization and maintainability.
                    </li>
                  </ul>
                </div>
              </div>
              <div className="relative">
                ...
                <div className="my-4 flex items-center gap-2">
                  ...
                  <time className="text-muted-foreground text-sm">23 Sep 2024</time>
                </div>
                <div className="prose dark:prose-invert max-w-none">
                  <h2 className="text-4xl">Infrastructure and Security Updates</h2>
                  <p>
                    We&apos;ve made significant improvements to our infrastructure and security
                    measures to ensure a more robust and secure platform.
                  </p>
                  <h3>Infrastructure updates:</h3>
                  <ul>
                    <li>
                      <b>Docker containers</b> - Improved deployment consistency and scalability
                    </li>
                    <li>
                      <b>Kubernetes</b> - Better container orchestration and auto-scaling
                    </li>
                    <li>
                      <b>Redis caching</b> - Faster response times and reduced database load
                    </li>
                  </ul>
                  <h3>Security enhancements:</h3>
                  <ul>
                    <li>
                      <b>OAuth 2.0</b> - Enhanced authentication and authorization flows
                    </li>
                    <li>
                      <b>Rate limiting</b> - Protection against DDoS attacks and abuse
                    </li>
                  </ul>
                </div>
              </div>
