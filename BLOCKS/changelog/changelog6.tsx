...
const changes = [
  {
    ...
    content: (
      <div className="prose dark:prose-invert">
        ...
        <p>
          We've listened to your feedback and rebuilt the UI from the ground up. The new design is
        ...
        <p>
          Connect your favorite tools seamlessly. We've added direct integrations for Slack, Google
          Drive, and Trello to streamline your workflows.
        </p>
        <blockquote>"Simplicity is the ultimate sophistication." - Leonardo da Vinci</blockquote>
        <p>We believe these updates will significantly enhance your productivity.</p>
        <table>
          <thead>
            <tr>
              <th>Integration</th>
        ...
        <p className="small">Note: Some integrations are progressively rolling out.</p>
        <p className="text-muted-foreground text-sm">We can't wait to hear what you think!</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="prose dark:prose-invert">
        ...
        <p>
          We've optimized critical pathways and database queries, resulting in noticeably faster
        ...
        <p>
          Developers can now leverage new API endpoints for managing user roles and accessing
          advanced analytics data. Check out the updated API documentation.
        </p>
        <blockquote>
            ...
            <Dialog key={idx}>
              <div className="relative flex w-full flex-col gap-4 py-16 lg:flex-row lg:gap-0">
                ...
                <div className="flex max-w-prose flex-col gap-4 lg:mx-auto">
                  <h3 className="text-3xl font-medium lg:text-4xl">{change.title}</h3>
                  ...
                  <p className="text-muted-foreground text-sm font-medium">{change.excerpt}</p>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <div className="flex items-center -space-x-2">
                        {change.contributors.slice(0, 3).map((contributor, idx) => (
                          <img
                            key={idx}
                            src={contributor}
                            alt={change.title}
              ...
              <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-prose">
                <DialogHeader>
                  <DialogTitle className="text-left">{change.title}</DialogTitle>
                  <DialogDescription className="text-left">{change.excerpt}</DialogDescription>
                </DialogHeader>
                <img
                  src={change.image}
                  alt={change.title}
