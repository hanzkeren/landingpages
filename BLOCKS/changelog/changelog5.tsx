...
const changelogs = [
  {
    ...
    description: (
      <div className="prose dark:prose-invert">
        <p>
          We've launched a new unified cloud storage system for managing all your creative assets
          (Media tab) and project files (Projects tab). This centralized hub allows you to access
          and organize all your creative resources from anywhere, on any device.
        </p>
        <ul>
          <li>
            The <a href="#">Asset Library</a> is now integrated within Cloud Storage.
          </li>
          <li>
            The Media tab includes advanced filtering and tagging options for better organization.
          </li>
          <li>
        ...
        <p>
          At launch, we're offering 50GB free storage for all users. Premium plans with expanded
          storage are available. We're also planning more integrations soon. If there's a specific
  ...
  },
  {
    ...
    description: (
      <div className="prose dark:prose-invert">
        <p>
          We're thrilled to announce major enhancements to our AI Design Assistant. These updates
          deliver smarter suggestions and more intuitive creative assistance across all Pixiol
          applications.
        </p>
        <ul>
          <li>40% faster rendering for AI-generated content suggestions</li>
          <li>New style recognition algorithm for more consistent design themes</li>
          <li>Expanded creative prompt capabilities with style parameters</li>
          <li>Specialized assistants for illustration, typography, and layout</li>
        </ul>
        <p>
          These improvements are rolling out to all subscription tiers automatically. No additional
          setup required to access these enhanced capabilities. For in-depth tutorials on maximizing
  ...
  },
  {
    ...
    description: (
      <div className="prose dark:prose-invert">
        <p>
          We've revamped our collaboration features to streamline creative teamwork within Pixiol.
          These updates focus on improving feedback loops and creative approval workflows.
        </p>
        <ul>
        ...
        <p>
          To explore these new collaboration capabilities and integrate them into your creative
            ...
            {changelogs.map((changelog, idx) => (
              ...
              >
                ...
                <span className="flex items-center gap-2">
                  ...
                  <p className="text-muted-foreground text-sm">{changelog.category}</p>
                </span>
                ...
                <div className="border-border mt-6 flex items-end justify-between border-b pb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-muted-foreground text-sm">{changelog.role}</p>
                    </div>
                  </div>
                  <time className="text-muted-foreground text-sm">{changelog.date}</time>
                </div>
              </div>
            ))}
          </div>
