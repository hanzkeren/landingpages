      ...
      <div className="container">
        <div className="text-center">
          <h1 className="mb-6 text-6xl font-semibold md:text-7xl">
            Changelog
            <sup>
              <Badge className="ml-2 bg-emerald-400 hover:bg-emerald-400">NEW</Badge>
            </sup>
          </h1>
          <p className="mx-auto max-w-lg text-lg">
            Everything that's new and improved now available on any plan and everywhere on the
            platform
          </p>
        ...
        <div className="border-border mx-auto mt-20 max-w-xl space-y-10 border-l border-dashed pl-6">
          <div>
            ...
            <p className="prose text-primary/80 dark:prose-invert">
              We've added a <a href="#">components</a> and <a href="#">analytics</a> to help you
              track your website's performance. You can now see your website's performance over
              time, and get insights into your users.
              <br />
              <br />
              As with all of our <a href="#">integrations</a>, we do the heavy lifting for you. It's
              easy to set up, privacy-focused, performant, and secure. We also handle cookie consent
              where required, in a very Supertape way.
            </p>
          </div>
          <div>
            <p className="text-muted-foreground relative font-mono text-sm">
