      ...
      <div className="container">
        <div className="flex flex-col gap-8">
          ...
          <p className="max-w-2xl text-muted-foreground">
            Our diverse group of professionals brings together expertise from design, engineering,
            and technology to deliver innovative solutions that transform ideas into reality.
          </p>
        </div>
        <div className="mt-14">
