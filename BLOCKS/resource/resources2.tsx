...
const blogs: Blog[] = [
  ...
  {
    title: 'A Comprehensive Guide to Modern Serverless Computing Architectures and Development',
    category: 'AI',
    date: 'Nov 26, 2024',
    author: [
      'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/avatar-2.webp',
  ...
  {
    title: 'The Evolution of Big Data Analytics: From Historical Insights to Predictive Models',
    category: 'Data',
    date: 'Nov 24, 2024',
    author: [
      'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/avatar-1.webp',
  ...
  {
    title: 'Emerging Trends in Natural Language Processing and Conversational AI',
    category: 'AI',
    date: 'Nov 23, 2024',
  ...
  {
    title: 'Breaking News: Revolutionary Advances in Quantum Computing Applications',
    category: 'News',
    date: 'Nov 21, 2024',
    author: [
      'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/avatar-1.webp',
  ...
  return (
    <section className="py-32">
      <div className="container">
        <h1 className="text-4xl font-medium sm:text-6xl md:text-7xl">Resources & Whitepapers</h1>
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-between p-8">
              ...
              <div className="flex flex-col gap-4">
                <h2 className="text-background text-xl font-medium">
                  Getting Started With Modern Digital Platforms and Infrastructure
                </h2>
                <div className="flex items-center gap-2">
                  <time className="text-background/80 text-sm">Dec 4, 2024</time>
          ...
          <div className="flex flex-col gap-4 lg:col-span-5 lg:row-span-2 lg:flex-col">
            ...
            >
              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-between p-8">
                ...
                <div className="flex flex-col gap-4">
                  <h2 className="text-background text-xl font-medium">
                    Streamlining Business Operations Through Effective Workflow Automation
                  </h2>
                  <div className="flex items-center gap-2">
                    <time className="text-background/80 text-sm">Feb 12, 2024</time>
                    <Avatar className="border-primary size-6 border">
                      <AvatarImage src="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/avatar-1.webp" />
                    </Avatar>
                  </div>
            ...
            >
              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-between p-8">
                ...
                <div className="flex flex-col gap-4">
                  <h2 className="text-background text-xl font-medium">
                    Boosting Overall Efficiency: How We Significantly Improved Search Performance
                  </h2>
                  <div className="flex items-center gap-2">
                    <time className="text-background/80 text-sm">Apr 1, 2025</time>
                    <Avatar className="border-primary size-6 border">
                      <AvatarImage src="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/avatar-1.webp" />
                    </Avatar>
                  </div>
