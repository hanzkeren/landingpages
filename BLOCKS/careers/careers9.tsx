      ...
      <div className="container max-w-6xl">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg">
            Join our team and help shape the future. We're looking for passionate people who are
            excited to tackle challenging problems and build amazing products.
          </p>
        </div>
        ...
        {jobs.map((job, idx) => (
          <React.Fragment key={idx}>
            ...
            >
              ...
              <span className="col-span-2 text-lg font-semibold">{job.role}</span>
