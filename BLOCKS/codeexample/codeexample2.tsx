...
import type { BundledLanguage } from '#app/components/kibo-ui/code-block';
import {
  CodeBlock,
  CodeBlockBody,
  CodeBlockContent,
          ...
          <div className="grid grid-cols-1 place-items-center gap-12 lg:grid-cols-2 lg:gap-6">
            <div className="relative flex flex-col gap-6">
              ...
              <p className="text-muted-foreground lg:text-lg">
                See how to make HTTP requests across different programming languages. From Node.js
                with fetch and axios, to Python with requests and httpx, Go with net/http. Each
                example shows POST requests with JSON payloads and proper headers.
              </p>
