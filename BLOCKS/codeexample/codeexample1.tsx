      ...
      <div className="container">
        <div className="grid place-items-center gap-10 lg:grid-cols-2 lg:gap-0">
          <div className="flex flex-col gap-6 lg:pr-20">
            <span className="text-muted-foreground text-lg">./database-setup.sh</span>
            ...
            <p className="text-muted-foreground md:text-lg">
              Connect faster and manipulate your data with database APIs and ORMs that are powerful
