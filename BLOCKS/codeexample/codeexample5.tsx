                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="rounded-lg p-2">
                        <img src={api.image} alt={api.title} className="size-6" />
                      </div>
                ...
                <div className="overflow-x-auto">
                  <TabsList className="grid w-full min-w-max grid-cols-3">
                    {currentApi?.code.map((code) => (
                      ...
                      >
                        <img src={code.icon} alt={code.language} className="size-4 flex-shrink-0" />
                        <span className="hidden lg:inline">{code.language}</span>
                      </TabsTrigger>
                    ))}
                  </TabsList>
                </div>
