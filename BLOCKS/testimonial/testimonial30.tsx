...
const testimonials = [
  {
    ...
    outcome: (
      <p className="text-muted-foreground">
        Completed <span className="text-foreground font-medium">12 major projects in 2 months</span>
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    outcome: (
      <p className="text-muted-foreground">
        Saved over 30 hours,{' '}
        <span className="text-foreground font-medium">reduced admin time by 60%</span>
      </p>
    ),
  },
];
    ...
    <section className="py-32">
      <div className="container">
        <div className="mb-12 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <h1 className="text-3xl font-semibold md:text-4xl">Loved by productivity enthusiasts</h1>
        ...
        >
          {testimonials.map((testimonial, index) => (
            <AccordionItem key={index} value={index.toString()} className="items-center">
              <AccordionTrigger className="hover:no-underline">
                <div className="flex flex-1 items-center gap-4">
                  <div className="max-w-3xs flex flex-1 items-center gap-4">
                    ...
                    <p className="text-lg font-medium tracking-tight">{testimonial.company}</p>
                  </div>
                  <div className="hidden text-base font-normal md:block">{testimonial.outcome}</div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="flex flex-col gap-12 px-0 py-4 md:flex-row md:items-center md:py-9 lg:px-12">
                ...
                <div className="flex flex-1 flex-col items-start">
                  ...
                  <div className="flex w-full justify-between">
                    <div>
                      <p className="mt-3 text-lg text-sm font-medium">{testimonial.author}</p>
