...
const DATA: DataItem[] = [
  {
    ...
    title: 'Google Sheets',
    description: 'Easily sync your data with Google Sheets for seamless automation.',
  },
  {
    id: 2,
    icon: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/slack-icon.svg',
    title: 'Slack',
    description: 'Receive updates and notifications directly in your Slack channels.',
  },
  {
    id: 3,
    icon: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/sketch-icon.svg',
    title: 'Sketch',
    description: 'Import your designs from Sketch and streamline your design process',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    title: 'Shopify',
    description: 'Sync your Shopify store data and streamline order management.',
  },
  {
    id: 6,
    icon: 'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/github-icon.svg',
    title: 'Github',
    description: 'Automate your workflows and track changes with Github integration.',
  },
];
    ...
    <section className="relative py-32">
      ...
      <div className="container relative flex max-w-5xl flex-col items-center text-center">
        ...
        <h2 className="text-muted-foreground mb-8 max-w-3xl lg:text-2xl">
          Enhance your workflow by connecting the tools you use daily. Our seamless integrations
          help you automate tasks and keep everything in sync.
        </h2>
      </div>
      ...
      <div className="mt-12 flex flex-row items-center justify-center gap-x-4">
        <span className="text-muted-foreground">Have a tool you'd like to integrate?</span>
        <Button asChild>
