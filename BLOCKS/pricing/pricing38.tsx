          ...
          <div className="border-border grid gap-12 rounded-sm border p-4 md:p-6 lg:grid-cols-2">
            <div className="flex flex-col gap-12">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-muted-foreground">
                  Choose from our comprehensive marketing packages designed to scale your business
                  from startup to enterprise level success.
                </p>
                <Alert className="bg-muted/50 w-fit items-center has-[>svg]:gap-x-2 [&>svg]:translate-y-0">
                  ...
                  <AlertTitle className="line-clamp-none text-xs">
                    All packages include a free consultation and strategy session.
                  </AlertTitle>
                </Alert>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <h2 className="text-2xl font-medium tracking-tight">Need a tailored approach?</h2>
                <p className="text-muted-foreground">
                  <a href="#" className="hover:text-primary transition-colors">
                    Contact us
                  </a>{' '}
                  for custom marketing solutions or to discuss specific campaign requirements that
                  align with your business goals.
                </p>
              </div>
              <Separator className="data-[orientation=horizontal]:w-12" />
              <div className="flex flex-col gap-4">
                <p className="text-muted-foreground text-xs font-medium uppercase">SUPPORT</p>
                <h2 className="text-2xl font-medium tracking-tight">Ongoing optimization</h2>
                <p className="text-muted-foreground">
                  We continuously monitor and optimize your campaigns for maximum ROI. Need
            ...
            <div className="space-y-6">
              <RadioGroup defaultValue="starter">
                ...
                >
                  <RadioGroupItem value="starter" id="starter" className="hidden" />
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-primary/80 text-sm">3 social media platforms</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <TrendingUp className="text-muted-foreground mt-0.5 size-4 shrink-0" />
                      <p className="text-primary/80 text-sm">Basic performance tracking</p>
                    </div>
                  </div>
                  <Separator />
                  <div className="grid gap-3 sm:grid-cols-2">
                ...
                >
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="flex items-start gap-2">
                      <Users className="text-muted-foreground mt-0.5 size-4 shrink-0" />
                      <p className="text-primary/80 text-sm">All major platforms included</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <TrendingUp className="text-muted-foreground mt-0.5 size-4 shrink-0" />
                      <p className="text-primary/80 text-sm">Advanced analytics & reporting</p>
                    </div>
                  </div>
                  <Separator />
                  <div className="grid gap-3 sm:grid-cols-2">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                      ...
                      <p className="text-muted-foreground text-sm">Unlimited growth potential</p>
                    </div>
                    <span className="text-2xl font-bold">
                      $99
                      <span className="text-muted-foreground text-base font-normal">/month</span>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="flex items-start gap-2">
                      <Users className="text-muted-foreground mt-0.5 size-4 shrink-0" />
                      <p className="text-primary/80 text-sm">Unlimited platform management</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <TrendingUp className="text-muted-foreground mt-0.5 size-4 shrink-0" />
                      <p className="text-primary/80 text-sm">Real-time performance monitoring</p>
                    </div>
                  </div>
                  <Separator />
                  <div className="grid gap-3 sm:grid-cols-2">
