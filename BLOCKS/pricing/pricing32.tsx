        ...
        <div className="flex flex-col items-center justify-center gap-9.5">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center justify-center gap-4">
              ...
              <Switch id="plan-duration" checked={checked} onCheckedChange={setChecked} />
              <Label
                htmlFor="plan-duration"
                className={`${checked ? 'text-foreground' : 'text-muted-foreground'} text-sm`}
              >
          ...
          <div className="mt-3 grid w-full grid-cols-1 gap-5 lg:grid-cols-6">
            {PLANS.map((plan, index) => (
              <PlanCard
                ...
                plan={plan}
                monthly={checked}
                className={index > PLANS.length - 3 ? 'lg:col-span-3' : 'lg:col-span-2'}
              />
            ))}
          </div>
        </div>
...
const PlanCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 mb-6 text-lg font-medium text-foreground">{plan.description}</div>
      <Button
        asChild
        className="w-full"
