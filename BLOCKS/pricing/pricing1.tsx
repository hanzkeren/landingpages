      ...
      <div className="h-[360px] flex-none">
        <div className="flex h-full flex-col">
          ...
          <div className="px-8 pb-6">
            <p className="line-clamp-2 text-balance text-muted-foreground">{tier.description}</p>
          </div>
            ...
            {tier.price && (
              <div className="mb-4 flex items-start justify-center">
                <div className="text-center">
                  ...
                  {tier.interval && (
                    <p className="mt-2 text-sm text-muted-foreground">{tier.interval}</p>
                  )}
                </div>
              </div>
            )}
    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto mb-20 max-w-5xl text-center">
          <h2 className="mb-3 text-4xl font-bold text-pretty lg:text-6xl">Pricing</h2>
