          ...
          <div className="mx-auto mt-4 grid w-full max-w-5xl gap-6 lg:grid-cols-3">
            ...
            <div className="w-full rounded-lg border bg-background p-8 shadow-sm lg:max-w-96">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-start font-semibold">
                  <p className="text-xl">$</p>
                  <p className="text-5xl leading-none">{isMonthly ? '20' : '15'}</p>
                </div>
                {!isMonthly && (
            ...
            <div className="w-full rounded-lg border bg-background p-8 shadow-sm lg:max-w-96">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-muted-foreground">For large teams and enterprises</p>
              </div>
              <Separator className="my-6" />
              <div className="flex items-center gap-2">
                <div className="flex items-start font-semibold">
                  <p className="text-xl">$</p>
                  <p className="text-5xl leading-none">{isMonthly ? '40' : '30'}</p>
                </div>
                {!isMonthly && (
                  <div className="flex flex-col text-sm">
                    <p className="font-semibold text-destructive">25% off</p>
