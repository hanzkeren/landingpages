  ...
  return (
    <section className="bg-muted py-32">
      <div className="container">
        <h1 className="mb-4 text-2xl md:text-3xl lg:mb-8 lg:text-4xl">Pricing Plans</h1>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
          {DATA.map((pkg, idx) => (
            ...
            >
              ...
              {/* Title */}
              <h2 className="mt-24 mb-2 text-base font-medium lg:text-2xl">{pkg.title}</h2>
              ...
              <div className="mb-6 flex-1">
                {pkg.features.map((feature, i) => (
                  <div
                    ...
                    className={cn(
                      'py-4',
                      i === 0 && 'border-t border-dashed border-muted-foreground',
