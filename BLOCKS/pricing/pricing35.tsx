...
const Pricing35 = () => {
  ...
  const updateBillingPeriod = (planId: string, period: 'quarterly' | 'yearly') => {
      ...
      <div className="container py-32">
        <header className="mb-10 flex flex-col items-center gap-6 md:mb-20">
          ...
          <p className="text-muted-foreground w-full max-w-lg px-4 text-center text-base font-normal tracking-tight opacity-70 md:px-0 md:text-lg">
            Lorem ipsum dolor sit amet consectetur adipiasicing elit.Lorem ipsum dolor sit amet
            consectetur
          </p>
        </header>
        ...
        <div className="flex flex-col justify-center gap-8 px-4 md:flex-row">
          {pricingPlans.map((plan) => {
            const currentPeriod = billingPeriods[plan.id as keyof typeof billingPeriods] as
              | 'quarterly'
              | 'yearly';
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mb-8 flex items-center gap-4 md:mb-10">
                    ...
                    <span className="whitespace-nowrap text-center text-xs font-normal uppercase opacity-50">
                      {plan.prices.yearly !== 'Custom' && currentPeriod === 'quarterly'
                        ? 'BILLED QUARTERLY'
                        : plan.prices.yearly !== 'Custom' && currentPeriod === 'yearly'
                          ? 'BILLED YEARLY'
                          : 'Flexible billing'}
                    </span>
                    <div className="bg-muted h-px flex-1" />
                  ...
                  <div className="mb-8 flex justify-center md:mb-10">
                    {plan.hasToggle ? (
                      <ToggleGroup
                        ...
                        value={currentPeriod}
                        onValueChange={(value) => {
                          if (value) updateBillingPeriod(plan.id, value as 'quarterly' | 'yearly');
                        }}
                  ...
                  <p className="mb-8 w-full text-center text-sm font-normal tracking-tight md:mb-10 md:text-base">
                    Ideal for individuals Or Freelancers getting started with our service. No credit
                    card required.
                  </p>

                  {/* CTA Button */}
                  <Button variant={plan.isDark ? 'secondary' : 'default'} className="h-10 w-full">
