              ...
              <div className="flex flex-col justify-between p-6 md:p-8">
                <div>
                  <div>
                    ...
                    <p className="mt-3 text-muted-foreground">
                      Get a premium custom solution built by a top Agency Partner, with Glide
                      helping manage development.
                    </p>
                  </div>
                  <p className="mt-6 text-sm font-semibold text-muted-foreground">Starting at</p>
                ...
                <div className="mt-8">
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <Check className="mr-2 size-4 text-primary" />
                      <span className="text-sm text-muted-foreground">Glide Priority Support</span>
                    </li>
                  </ul>
          ...
          <li className="rounded-lg border bg-card p-6 md:p-8">
            <div className="flex h-full flex-col justify-between">
              <div>
                ...
                <p className="mt-3 text-muted-foreground">
                  Browse the Expert Directory to find a Glide Certified Expert who best fits your
                ...
                <Button size="lg" variant="secondary" className="mt-5 w-fit rounded-3xl">
                  Browse Experts
                </Button>
              </div>
              ...
              <div className="mt-8">
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <Check className="mr-2 size-4 text-primary" />
                    <span className="text-sm text-muted-foreground">Hire hourly or by project</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="mr-2 size-4 text-primary" />
                    <span className="text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start">
                    <Check className="mr-2 size-4 text-primary" />
                    <span className="text-sm text-muted-foreground">Glide Support</span>
                  </li>
                </ul>
                <Button variant="link" className="mt-4 px-0">
                  Learn more
