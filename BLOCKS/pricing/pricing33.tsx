      ...
      <div className="container">
        <div className="flex w-full flex-col items-center gap-4">
          <Badge className="flex items-center gap-2 rounded-full border border-muted bg-background px-4 py-1.5">
            ...
            <p className="text-sm leading-5 font-medium text-foreground">Add-ons</p>
          </Badge>
              ...
              >
                <div className="flex w-full flex-col gap-4 p-6 md:flex-row">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-base text-muted-foreground">{addon.description}</p>
                  </div>
                </div>
                <div className="flex w-full flex-col items-center gap-2 p-6 md:flex-row">
                  <div className="flex w-full flex-wrap items-center gap-4 md:flex-nowrap">
                    <div className="text-lg font-semibold">{addon.price.amount}</div>
                    <div className="text-xs text-muted-2-foreground">{addon.price.unit}</div>
                  </div>
                  <Button variant="outline" className="block h-12 w-full px-4 md:max-w-[10.625rem]">
