    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-4 text-4xl font-semibold lg:text-5xl">Choose the right plan for you</h2>
        </div>
        ...
        <div className="mx-auto mb-12 flex max-w-3xl items-center justify-center gap-4">
          ...
          <div className="ml-8 flex items-center gap-4">
            <span className="text-sm font-medium">50K+ developers trust us</span>
            <div className="bg-border h-8 w-px" />
            <span className="text-sm font-medium">Cancel any time, without any hassle</span>
          </div>
        </div>
          ...
          <div className="bg-muted flex h-12 items-center rounded-full p-1">
            ...
            >
              ...
              <div className='has-[button[data-state="checked"]]:bg-background h-full rounded-full transition-all'>
                ...
                >
                  Yearly
                  <Badge variant="outline" className="bg-primary text-secondary ml-2 px-1.5">
                    Save 20%
                  </Badge>
                </Label>
              </div>
              ...
              <div className="flex h-full flex-col justify-between gap-5">
                <div>
                  ...
                  <Button className="mt-6 w-full rounded-full">
                    {pkg.title === 'Enterprise Plan' ? 'Contact Sale' : 'Get ' + pkg.title}
                  </Button>
                  <div className="mt-6">
