  ...
  return (
    <section className="py-32">
      <div className="container">
        <h1 className="mb-8 text-3xl font-bold md:mb-12 md:text-5xl">Compare us with others.</h1>
                ...
                <React.Fragment key={idx}>
                  ...
                  <div className="border-b bg-green-50 p-3 md:p-6">
                    <div className="flex items-center gap-2">
                      {row.hasIcon && <CheckCircle2 className="h-5 w-5 text-green-600" />}
                      <span className="text-base md:text-lg">{row.lightbox}</span>
                    </div>
                  </div>
                  <div className="border-b bg-red-50 p-3 md:p-6">
                    <div className="flex items-center gap-2">
                      {row.hasIcon && <OctagonX className="h-5 w-5 text-red-600" />}
                      <span className="text-base md:text-lg">{row.freelance}</span>
                    </div>
                  </div>
                </React.Fragment>
              ))}
