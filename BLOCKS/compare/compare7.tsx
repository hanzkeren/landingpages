        ...
        <div className="mx-auto max-w-3xl overflow-x-auto">
          <Table className="rounded border text-left shadow-lg">
            <TableHeader>
              <TableRow>
                <TableHead></TableHead>
                <TableHead className="bg-muted px-6 py-4 font-semibold">Shadcn</TableHead>
                <TableHead className="px-6 py-4 font-semibold">Bootstrap</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody className="text-foreground">
              <TableRow>
                <TableCell className="px-6 py-4">Design System</TableCell>
                <TableCell className="bg-muted px-6 py-4">Modern, Utility-first</TableCell>
                <TableCell className="px-6 py-4">Classic, Component-based</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="px-6 py-4">Customization</TableCell>
                <TableCell className="bg-muted px-6 py-4">Highly customizable</TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="bg-muted px-6 py-4">Focus on a11y</TableCell>
                ...
                <TableCell className="relative px-6 py-4">
                  <Tooltip>
                    ...
                    <TooltipContent sideOffset={8} className="max-w-xs">
                      ...
                      Some advanced components are only available in paid versions or require
              ...
              <TableRow>
                ...
                <TableCell className="relative px-6 py-4">
                  <Tooltip>
                    ...
                    <TooltipContent sideOffset={8} className="max-w-xs">
                      <span className="mb-1 block font-semibold">Figma Kit Unavailable</span>
                      Bootstrap does not provide an official Figma kit, but community kits may
                      exist.
                    </TooltipContent>
                  </Tooltip>
                </TableCell>
