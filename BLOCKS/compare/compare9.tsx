            ...
            <Table>
              ...
              <TableBody>
                {comparisonData.map((row, index) => (
                  ...
                  >
                    <TableCell className="text-foreground py-4 font-medium">{row.metric}</TableCell>
                    <TableCell
                      className={cn(
                        ...
                        hoveredModel === 'gpt4' && 'bg-red-50/80 dark:bg-red-950/30'
                      )}
                      ...
                      className={cn(
                        ...
                        row.claude.status === 'best'
                          ...
                          : row.claude.status === 'worst'
                            ? 'bg-red-50 text-red-600 dark:bg-red-950/20'
                            : 'text-foreground bg-muted/50',
                        hoveredModel === 'claude' && 'bg-blue-50/80 dark:bg-blue-950/30'
                      )}
                      ...
                      className={cn(
                        ...
                        row.gemini.status === 'best'
                          ...
                          : row.gemini.status === 'worst'
                            ? 'bg-red-50 text-red-600 dark:bg-red-950/20'
                            : 'text-foreground bg-muted/50',
                        hoveredModel === 'gemini' && 'bg-green-50/80 dark:bg-green-950/30'
                      )}
            ...
            <div className="relative">
              ...
              <div className="text-muted-foreground space-y-3 font-mono text-xs">
                <div className="grid gap-2 md:grid-cols-3">
                  ...
                  >
                    <div className="text-foreground mb-1 font-medium">GPT-4o</div>
                  ...
                  >
                    <div className="text-foreground mb-1 font-medium">Claude 3.5</div>
                    <div className="space-y-1">
                  ...
                  >
                    <div className="text-foreground mb-1 font-medium">Gemini Pro 1.5</div>
                    <div className="space-y-1">
                ...
                <div className="border-border/30 bg-background/50 mt-4 rounded border p-3">
                  <div className="text-foreground mb-2 font-medium">Performance Summary</div>
                  <div className="space-y-1">
                    <div>• GPT-4o: Fastest response times with strong code generation</div>
                    <div>
                      • Claude 3.5: Excellent reasoning capabilities and balanced performance
                    </div>
                    <div>• Gemini Pro 1.5: Best value proposition with competitive pricing</div>
                  </div>
                </div>
              </div>
            </div>
