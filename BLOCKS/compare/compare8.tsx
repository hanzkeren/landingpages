...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: 'Premium components available in Shadcn, not included in Bootstrap.',
    shadcn: true,
    bootstrap: false,
    tooltip: {
      content: (
        <>
          ...
          Some advanced components are only available in paid versions or require third-party
          libraries.
        </>
      ),
    },
