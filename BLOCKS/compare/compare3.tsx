      ...
      <div className="container">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="mx-auto mt-2 max-w-2xl text-center text-muted-foreground">
            Discover why our customers choose Acme over other document management solutions
          </p>
        </div>
        <div className="-mx-7 overflow-x-auto">
          <div className="mt-14 grid min-w-2xl grid-cols-3">
            ...
            <div className="flex flex-col items-center justify-center gap-2 border-b border-border bg-muted p-5">
              ...
              <span className="text-xs text-muted-foreground">Comprehensive dashboard</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 border-b border-border p-5">
              ...
              <span className="text-xs text-muted-foreground">Basic overview only</span>
            </div>
            <div className="flex items-center gap-2 border-b border-border p-5">
            ...
            <div className="flex flex-col items-center justify-center gap-2 border-b border-border p-5">
              <CheckCircle className="size-5 text-green-600" />
              <span className="text-xs text-muted-foreground">Limited options</span>
            </div>
            <div className="flex items-center gap-2 border-b border-border p-5">
            ...
            <div className="flex flex-col items-center justify-center gap-2 border-b border-border p-5">
              <CircleMinus className="size-5 text-red-600" />
              <span className="text-xs text-muted-foreground">No API available</span>
            </div>
            <div className="flex items-center gap-2 border-b border-border p-5">
            ...
            <div className="flex flex-col items-center justify-center gap-2 border-b border-border bg-muted p-5">
              <CircleMinus className="size-5 text-red-600" />
              <span className="text-xs text-muted-foreground">Coming Q3 2025</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 border-b border-border p-5">
              <CheckCircle className="size-5 text-green-600" />
              <span className="text-xs text-muted-foreground">Basic reporting</span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-2 border-border bg-muted p-5">
              <CheckCircle className="size-5 text-green-600" />
              <span className="text-xs text-muted-foreground">24/7 dedicated team</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-2 p-5">
              <CircleMinus className="size-5 text-red-600" />
              <span className="text-xs text-muted-foreground">Email support only</span>
            </div>
