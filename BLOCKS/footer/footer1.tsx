import { FaApple, FaDiscord, FaRedditAlien, FaTelegramPlane, FaTwitter } from 'react-icons/fa';

import { Logo, LogoImage, LogoText } from '#app/components/shadcnblocks/logo';
