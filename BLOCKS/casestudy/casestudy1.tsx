          ...
          <div className="relative flex-col gap-10 lg:flex lg:flex-row lg:justify-between">
              ...
              <div className="max lg:col-span-2">
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 text-lg">
                    ...
                    unfolded about a king who decided to tax the very essence of joy itself - jokes
                    and jest.
                  </p>
                  <img
                  ...
                  <div className="mb-8 grid grid-cols-2 gap-5 lg:grid-cols-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <p className="text-4xl font-semibold sm:text-5xl">&gt;85%</p>
                      <p className="text-muted-foreground text-sm">
            ...
            <div className="h-fit lg:sticky lg:top-8 lg:max-w-80">
              ...
              <p className="text-muted-foreground mb-5 text-sm">
                Our client implemented our solution to transform their business operations,
                resulting in improved efficiency, enhanced customer experience, and significant cost
                savings across their entire organization.
              </p>
