        ...
        <div className="relative mt-20 flex flex-col gap-x-6 gap-y-16 lg:flex-row">
          <aside className="mx-auto h-fit max-w-prose lg:sticky lg:top-10 lg:mx-0 lg:w-64 lg:max-w-none">
            ...
            <div className="mt-6 grid grid-cols-2 gap-5 lg:grid-cols-1">
              <div className="col-span-2 lg:col-span-1">
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  A modern platform designed to simplify workflows, automate processes, and drive
                  innovation at scale. It is the central foundation for product and customer data,
                  on top of which high impact workflows are built.
                </p>
              </div>
              <div>
                <h2 className="font-semibold">Sector</h2>
                <p className="text-muted-foreground mt-1 text-sm">Technology; Automation</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1 text-sm">San Francisco, California</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1 text-sm">$25m (Series A)</p>
              </div>
              <div>
            ...
            <div className="mt-10 flex flex-col">
              <span className="text-muted-foreground mb-2 text-sm">Share this content:</span>
              ...
              <div className="grid gap-x-10 gap-y-7 rounded-3xl border p-6 lg:grid-cols-2 lg:gap-y-10 lg:border-none lg:p-0">
                <div>
                  ...
                  <p className="text-muted-foreground mt-3">
                    The team faced difficulties aligning their growth strategy with a rigid data
                    model, causing inefficiencies and limited access to essential customer insights.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-3">
                    Adopted a flexible platform as the central hub for data, enabling the creation
                    of impactful workflows to drive growth.
                  </p>
                </div>
                <div className="border-t pt-10 lg:col-span-2">
                  ...
                  <ul className="mt-3 grid gap-x-10 gap-y-3 lg:grid-cols-2">
                    ...
                    <li className="flex gap-3">
                      <CheckCircle2 className="mt-0.5 size-5 shrink-0" />
                      <p className="font-semibold">
                        A customizable CRM that mirrors their data and integrates seamlessly with
                        their tools
                      </p>
                    </li>
                    <li className="flex gap-3">
