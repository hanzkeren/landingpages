      ...
      <div className="container">
        <div className="flex flex-col rounded-xl border lg:flex-row">
          <div className="grow px-8 py-8 lg:px-16">
            ...
            <div className="mt-4 max-w-xl">
              ...
              <p className="mt-4 text-muted-foreground md:text-lg">
                Our platform streamlines complex operations at scale, providing comprehensive
                insights and intelligent automation capabilities. Achieve greater efficiency and
                productivity with our proven enterprise tools.
              </p>
            </div>
          ...
          <div className="flex grow basis-5/12 flex-col justify-between border-t lg:border-t-0 lg:border-l">
            ...
            >
              <div className="flex gap-4">
                <Layers className="size-8 shrink-0 md:size-10" strokeWidth={1.5} />
                <div className="flex flex-col gap-1">
