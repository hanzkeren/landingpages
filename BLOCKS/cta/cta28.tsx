  ...
  return (
    <section className="py-32">
      <div className="container">
        <div className="relative grid grid-cols-1 overflow-hidden rounded-[0.75rem] bg-black px-8 pt-10 pb-12 xl:grid-cols-2 xl:px-15.5 xl:pb-15.5">
          <div className="flex flex-col gap-6 md:gap-9">
            <p className="font-serif text-4xl text-white md:text-6xl lg:text-7xl">
