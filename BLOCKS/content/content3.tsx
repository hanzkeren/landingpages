    ...
    <section className="py-32">
      <div className="container">
        ...
        <p className="mt-5 max-w-2xl text-balance text-xl font-medium">
          Transform your apartment balcony or tiny yard into a thriving green oasis with our proven
          techniques.
        </p>
        ...
        <div className="relative mt-16 grid gap-10 lg:mt-28 lg:grid-cols-5">
          <aside className="top-10 flex h-fit w-full max-w-56 flex-col gap-5 lg:sticky">
            ...
            <div>
              ...
              <time className="text-muted-foreground text-sm">April 15, 2024</time>
            </div>
          </aside>
          <div className="gap-6 lg:col-span-3">
            <div className="max-w-prose lg:mx-auto">
              ...
              <div className="prose dark:prose-invert prose-h3:mt-14 prose-h3:scroll-mt-14 prose-h3:text-lg mt-12">
                ...
                <p>
                  This guide will help you create a thriving garden even in the smallest urban
                  spaces. With strategic planning and the right plant selection, anyone can enjoy
                  homegrown herbs, vegetables, and flowers, regardless of square footage.
                </p>
                <h3 id="heading2" ref={(ref) => addSectionRef('heading2', ref)}>
                  Getting Started
                </h3>
                <p>
                  Before diving into urban gardening, consider these essential requirements for
                  success. This checklist will help you avoid common beginner mistakes and set up
                ...
                <p>Once you've set up, you'll need to select appropriate plants for your space.</p>
                <div>
                  <table>
                    <thead>
                      <tr>
                ...
                <p>
                  By matching plants to your light conditions, you'll see dramatic improvements in
                  growth and yield. Remember that even in challenging spaces, there's always
                  something that can thrive.
                </p>
                <Alert>
                  <Lightbulb className="h-4 w-4" />
                  <AlertTitle>Pro Tip!</AlertTitle>
                  <AlertDescription>
                    Always group plants with similar water needs together to simplify maintenance
                ...
                <p>
                  ...
                  <a href="#">Vertical gardening techniques</a> can double or triple your growing
                  capacity.
                </p>
                <blockquote>
                ...
                <ul>
                  ...
                  <li>Trellises for climbers: Great for beans, peas, and cucumbers</li>
                </ul>
                <p>
                  With these strategies, even a tiny balcony can produce an impressive harvest
                  throughout the growing season, bringing both beauty and bounty to your urban
                  dwelling.
                </p>
              </div>
            </div>
