        ...
        <div>
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-lg">
              Our content management system allows you to easily organize and showcase your work.
              Share your portfolio, products, or services with your audience.
            </p>
            <img
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Share photos and visual content.</p>
                </div>
              </a>
              <a
                href="#"
          ...
          <section className="prose dark:prose-invert mb-8">
            ...
            <ol>
              ...
              <li>Choose your content type and fill in the required information.</li>
              <li>
            ...
            <Alert>
              ...
              <AlertDescription>
                You can quickly create content by using our bulk upload feature or content
                templates.
              </AlertDescription>
            </Alert>
          </section>
          <section className="prose dark:prose-invert mb-8">
            ...
            <ol>
              <li>
                Go to <strong>Content</strong> and locate the item you want to modify.
              </li>
              <li>
