...
import { Sheet, SheetClose, SheetContent, SheetTitle } from '#app/components/ui/sheet';
          ...
          <div className="flex items-center justify-between gap-3.5 py-5">
            ...
            <div className="flex items-center gap-3.5">
              {NAV_BUTTONS.map((button, index) => (
                <Button key={`nav-button-${index}`} variant={button.variant} asChild>
              ...
              <ul>
                {item.links.map((link, index) => (
                  <li key={`desktop-nav-sublink-${index}`}>
                    ...
                    >
                      <div>
                        <h3 className="font-medium leading-normal">{link.label}</h3>
                        <p className="text-muted-foreground leading-normal">{link.description}</p>
                      </div>
                    </a>
                  </li>
                ))}
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="container pb-12">
            ...
            <div className="flex justify-end pt-5">
              <SheetClose asChild>
                <Button size="icon" className="bg-muted/20 hover:bg-muted/20 size-9 rounded-full">
            ...
            <div className="gap-30 flex h-full flex-col justify-between pt-24">
              <div className="grid w-full grid-cols-2 gap-x-4 gap-y-10">
                {MOBILE_NAVIGATION.map((item, index) => renderMobileMenuItem(item, index))}
              </div>
              <div className="col-span-2 flex flex-col gap-4">
                <div className="text-muted-2-foreground text-xs uppercase">SOCIAL</div>
