      ...
      <div className="flex w-full items-center justify-between">
        <div className="flex gap-2.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-muted-foreground/80 text-sm leading-[1.2]">{link.description}</p>
          </div>
        </div>
...
const GithubStars = ({ repoUrl }: GithubStarsProps) => {
  ...
  return (
    <Button variant="ghost" asChild className="bg-muted text-foreground flex items-center gap-1.5">
      <a href={repoUrl}>
