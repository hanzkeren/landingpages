...
const Navbar14 = () => {
  ...
  return (
    <section className={cn('border-border border-b lg:border-b', isOpen && 'border-b-0')}>
                ...
                <NavigationMenuList>
                  <NavigationMenuItem>
                    ...
                    <NavigationMenuContent className="p-0">
                      <div className="flex">
                        <div className="p-4">
                          <p className="text-muted-foreground mb-3 text-[10px] uppercase">TOOLS</p>
                        ...
                        <div className="p-4">
                          ...
                          <NavigationMenuLink className="cursor-pointer">
                            ...
                            <div className="mt-3.5 flex flex-col gap-2 px-1">
                              <p className="text-xs font-medium">One Platform. Every Learner.</p>
                  ...
                  <NavigationMenuItem>
                    ...
                    <NavigationMenuContent className="p-0">
                      <div className="flex">
                        <div className="p-4">
                          <p className="text-muted-foreground mb-3 text-[10px] uppercase">GUIDES</p>
                          {docs.map((doc) => (
                            <NavigationMenuLink
                              key={doc.title}
                              className="group flex cursor-pointer flex-row gap-3"
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="space-y-5">
                        ...
                        >
                          <BookOpen className="size-4" />
                          <span className="text-sm font-medium">Shadcnblocks 101</span>
                        </a>
                        <a
                          href="#"
                          className="flex cursor-pointer flex-row items-center gap-3 rounded-md transition-colors"
              ...
              <AccordionItem value="support" className="last:border-b">
                ...
                <AccordionContent>
                  <div className="space-y-4">
                    ...
                    <Separator />
                    <div>
                      <p className="text-muted-foreground mb-3 text-[10px] uppercase">ABOUT US</p>
                      <div className="space-y-5">
                        {company.map((companyItem) => (
                          ...
                          >
                            ...
                            <span className="text-sm font-medium">{companyItem.title}</span>
                          </a>
                        ))}
                      </div>
                    </div>
