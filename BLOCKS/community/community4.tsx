    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col items-center gap-2.5 text-center">
          <h2 className="text-4xl font-medium md:text-5xl">Join our community</h2>
          ...
          {socialPlatforms.map((platform) => (
            <a
              ...
              className={cn(
                ...
                platform.color === 'pink' && 'from-pink-500 dark:border-pink-500/50',
                platform.color === 'blue' && 'from-blue-500 dark:border-blue-500/50',
                platform.color === 'red' && 'from-red-500 dark:border-red-500/50',
                platform.color === 'zinc' && 'from-zinc-500 dark:border-zinc-500/50'
              )}
            >
              ...
              <div className="flex h-full flex-col justify-between">
                <div className="mb-5">
                  <h3 className="relative text-lg font-semibold text-white">{platform.heading}</h3>
                  <p className="mt-2 text-sm text-white/70">{platform.description}</p>
                </div>
