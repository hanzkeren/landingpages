        ...
        <div className="container flex flex-col max-lg:divide-y lg:flex-row">
          <div className="flex-1 lg:border-l">
            <div className="lg:border-b lg:pr-8 lg:pb-5 lg:pl-2">
              ...
              <p className="mt-6 tracking-[-0.32px] text-muted-foreground">
                Our mission is to unlock potential by creating tools that elevate productivity and
          ...
          <div className="lg:border-x lg:px-8">
            ...
            <p className="mt-10 px-4 tracking-[-0.32px] text-muted-foreground md:mt-14">
              Our mission is to enable individuals and teams to achieve their best work by
              delivering innovative tools that simplify workflows, enhance collaboration, and drive
              impactful outcomes. We&apos;re dedicated to creating a seamless productivity
              experience that helps people thrive in their work and reach new heights.
            </p>
          </div>
        </div>
      </div>
