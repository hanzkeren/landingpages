    ...
    <section className="bg-muted">
      <div className="container py-12 sm:py-32">
        <div className="relative grid gap-12 lg:grid-cols-2 lg:gap-24">
          <div className="">
            <span className="mb-4 block font-mono text-lg font-medium">Library / Playlist</span>
            ...
            <p className="pt-10 text-lg leading-8 text-foreground">
              Discover innovative solutions tailored to transform your vision into reality. Explore
              new ways to elevate your projects with creativity and precision.
            </p>
          ...
          <div>
            ...
            <div className="relative mx-auto max-w-[596px] overflow-hidden rounded-lg bg-primary pt-6 pl-6 lg:mx-0">
              <AspectRatio ratio={0.9104 / 1} className="overflow-hidden rounded-tl-md">
                <img
                  alt=""
