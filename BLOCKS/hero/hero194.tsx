        ...
        <div className="grid h-full w-full grid-cols-1 lg:max-h-[37.5rem] lg:grid-cols-2">
          <div className="flex w-full max-w-[90%] flex-col justify-center gap-5 py-16 pr-10 pl-20 md:max-w-[70%] lg:max-w-full lg:py-0">
            ...
            <p className="text-sm text-muted-foreground md:text-base">
              Enhance your photos with cutting-edge technology that brings out the vibrant colors
              and intricate details of the natural world. Perfect for photographers of all levels,
              our app makes capturing stunning images effortless.
            </p>
