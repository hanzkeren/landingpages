          ...
          <ul className="flex flex-col gap-4">
            <li className="flex items-center gap-2">
              <div className="flex h-7 w-7 rounded-full bg-accent">
                <Check className="m-auto size-4 stroke-foreground" strokeWidth={3} />
              </div>
              <div className="text-foreground">Average 9% Return on Investment</div>
            </li>
            <li className="flex items-center gap-2">
              <div className="flex h-7 w-7 rounded-full bg-accent">
                <Check className="m-auto size-4 stroke-foreground" strokeWidth={3} />
            ...
            <li className="flex items-center gap-2">
              ...
              <div className="text-foreground">Investments chosen by certified SGRs</div>
            </li>
          </ul>
          <Button
            asChild
