          ...
          <div className="flex flex-col">
            <div className="flex flex-col items-center justify-center gap-8">
              ...
              <p className="max-w-[53.125rem] text-center text-lg leading-snug text-muted-foreground md:text-xl">
                Sign up on our website and use your account for as long as you’d like. Our team is
                always available to assist and dedicated to solving any issues you encounter.
              </p>
