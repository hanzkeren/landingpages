    ...
    <section className="py-32">
      <div className="container">
        <div className="mx-auto mb-12 flex max-w-5xl flex-col items-center gap-6">
          <a href="#" className="flex items-center gap-2 rounded-full bg-muted py-1 pr-4 pl-1">
          ...
          <p className="text-center text-lg text-muted-foreground md:text-xl">
            Streamline your workflow, collaborate with your team, and boost productivity with our
            innovative platform.
          </p>
          ...
          <p className="text-sm text-muted-foreground">14-day free trial. No obligations.</p>
        </div>
        <img
