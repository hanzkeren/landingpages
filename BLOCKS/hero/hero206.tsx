      ...
      <div className="container relative py-32">
        ...
        >
          ...
          <p className="ml-6 capitalize tracking-tight md:text-lg">
            {' '}
            Trusted by <span className="text-foreground font-bold">10k+</span> users.
          </p>
        </Badge>
...
const BrowserMockup = ({
  ...
  <div className={cn('rounded-4xl relative w-full overflow-hidden border', className)}>
    ...
    <div className="relative w-full">
      ...
      />
      <img src={DahboardUrlMobile} alt="" className="block h-full w-full object-cover md:hidden" />
    </div>
