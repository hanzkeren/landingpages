    ...
    <section className="relative overflow-hidden">
      <div className="container">
        ...
        <div className="relative mb-16">
          ...
          <SlideIndicator currentSlide={currentSlide} slides={SLIDES} className="mt-8" api={api} />
        </div>
        ...
        <div className="space-y-12 text-center">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="text-muted-foreground mt-6 text-xl font-medium lg:text-2xl">
              Streamline is the fit-for-purpose tool for planning and building modern software
              products.
            </p>
          </div>
