          ...
          <div>
            <div className="flex max-w-[40.625rem] flex-col gap-8">
              ...
              <p className="text-lg text-balance text-muted-foreground">
                Ditch pen-and-paper bookings and focus on growing your business or relishing your
                newfound free time.
              </p>
              <HeroFrom />
              ...
              <div className="flex flex-col gap-1.5 py-4">
                ...
                <div className="flex items-center gap-2">
                  <Check className="stroke-muted2-foreground size-4" />
                  <p className="text-lg font-medium text-muted-2-foreground">14 days free trial</p>
                </div>
              </div>
            </div>
          </div>
          <div>
            <div className="relative mx-auto aspect-[0.990343348/1] w-full max-w-[42.5rem]">
              <div className="absolute top-[5.04%] left-[4.33%] z-20 w-[42.25%]">
                <AspectRatio ratio={0.857142857 / 1} className="overflow-hidden">
                  <img
              ...
              <div className="absolute right-[8.23%] bottom-[12.87%] z-20 w-[42.25%]">
                <AspectRatio ratio={0.789473684 / 1} className="overflow-hidden">
                  <img
              ...
              <div className="absolute bottom-[5%] left-[10.94%] z-30 w-[42.25%]">
                <AspectRatio ratio={0.894495413 / 1} className="overflow-hidden">
                  <img
