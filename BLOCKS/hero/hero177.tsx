      ...
      <div className="container">
        <div className="mx-auto flex max-w-[77.5rem] flex-col items-center gap-8">
          ...
          <p className="max-w-[54.375rem] text-center text-lg text-muted-foreground md:text-xl">
            Eliminate fuel theft and overspending with a fuel card that has been shown to lower fuel
            costs by an average of 24%¹. Our advanced software streamlines expense tracking, card
            management, and accounting, making these tasks easier and faster than ever.
          </p>
          <ul className="flex flex-col gap-2 text-left md:flex-row md:justify-center md:gap-6 md:text-center">
            ...
            <li className="flex items-center gap-3">
              <CircleCheck className="size-6 fill-primary stroke-background" />
              <p className="text-muted-2-foreground">US-based customer service</p>
            </li>
            <li className="flex items-center gap-3">
              <CircleCheck className="size-6 fill-primary stroke-background" />
