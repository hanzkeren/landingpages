          ...
          <div>
            <div className="flex flex-col gap-3">
              ...
              <p className="text-foreground mb-5 text-lg">
                Our service is a usage-based billing platform designed to accelerate your product
                launches. Effortlessly shape your pricing today and refine it with confidence
                tomorrow.
              </p>
              <div>
                <div className="flex flex-col items-center gap-4 lg:flex-row">
                  ...
                  <Button variant="ghost" asChild className="group flex h-fit items-center gap-2">
                    <a href="#">
