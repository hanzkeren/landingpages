      ...
      <div className="container">
        <div className="mx-auto max-w-[48.75rem]">
          ...
          <p className="mx-auto mb-9 max-w-[37.5rem] text-center text-base font-medium text-foreground md:text-lg">
            Experience a revolutionary dashboard that empowers your team with real-time data,
            efficient project management, and enhanced collaboration tools.
          </p>
          <div className="mb-10 flex flex-wrap items-center justify-center gap-5">
            <Button asChild className="block h-fit w-fit rounded-md px-7 py-[0.875rem] font-medium">
              <a href="#">Download</a>
            </Button>
            <Button
              variant="secondary"
          ...
          <p className="mb-4 text-center text-muted-foreground">Explore our integration options.</p>
