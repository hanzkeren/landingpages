        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div className="flex flex-col gap-8 lg:gap-12">
            <h1 className="text-5xl font-semibold lg:text-7xl">
              Your workspace <br />
              <span className="mx-1 inline-block whitespace-nowrap">anywhere.</span>
            </h1>
            <p className="text-muted-foreground lg:text-lg">
              Set up your environment with everything you need and share it effortlessly. Stay
              productive throughout your workflow, no matter where you are.
            </p>
