      ...
      <div className="container">
        <div className="flex flex-col justify-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-center text-lg text-muted-foreground">
            Our library is compatible with all popular frameworks, download our SDK and get started
            in minutes.
          </p>
          <div className="mx-auto mt-8 mb-12 flex h-[60px] w-fit items-center gap-2 rounded-md bg-muted px-4 py-2 text-center">
            ...
            >
              ...
              <p className="border-l px-2 font-mono text-sm">{technologies[current]?.command}</p>
            </div>
          </div>
        </div>
        <Carousel
