...
const Illustration1 = (props: any) => {
  return (
    <motion.svg xmlns="http://www.w3.org/2000/svg" width={460} height={233} fill="none" {...props}>
      ...
      <path stroke="url(#g)" d="M459.649 152.723 351.613 69.264a11 11 0 0 1-4.275-8.705V.074" />
      <path stroke="url(#h)" d="m.338 152.723 108.036-83.459a11 11 0 0 0 4.275-8.705V.074" />
      <defs>
        <linearGradient
          id="a"
          x1={141.838}
