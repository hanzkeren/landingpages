...
import { Cover } from '#app/components/aceternity/cover';
      ...
      <div className="container grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="w-full space-y-5">
          ...
          <p className="text-muted-foreground max-w-xl">
            Join 10,000+ developers who've accelerated their growth with our components. Average 40%
            faster time-to-market and 25% increase in conversion rates.
          </p>
          ...
          <ul className="space-y-4">
            <li className="mb-3">
              <p className="font-semibold tracking-tight opacity-50">How we help you grow</p>
            </li>
