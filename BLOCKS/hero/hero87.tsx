  ...
  return (
    <section className="py-32">
      <div className="container">
        <h1 className="text-5xl lg:text-7xl">The Perfectly Adaptable Product for Your Business</h1>
        <div className="mt-14 grid gap-10 lg:grid-cols-2">
          <div>
            <p className="text-lg text-muted-foreground lg:text-xl">
              It delivers unique and customizable products designed for your business. Say farewell
              to rigid options, lengthy launch times, and branding limitations. Embrace a product
              that evolves with your needs and fuels your innovation. Highnote is the adaptable
