        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <p className="my-8 max-w-xl text-muted-foreground lg:text-lg">
              Build stunning web applications faster with our premium collection of ready-to-use UI
              components. Perfect for developers and designers.
            </p>
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex -space-x-4">
                {[1, 2, 3, 4, 5].map((num) => (
                  ...
                  >
                    <AvatarImage src={`/images/block/avatar-${num}.webp`} alt={`Avatar ${num}`} />
                  </Avatar>
                ))}
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start">
                ...
                <p className="text-sm font-medium text-muted-foreground">1000+ happy developers</p>
              </div>
            </div>
          </div>
