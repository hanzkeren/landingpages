...
function TestimonialCard({
  ...
  return (
    <div
      className={cn('bg-card flex w-[320px] flex-col gap-4 rounded-lg p-6 shadow-sm', className)}
      style={style}
    >
      <img src={imageSrc} alt={name} className="h-24 w-24 rounded-md object-cover" />
...
function RatingDisplay({ rating = 4.9, userCount = 500, className, style }: RatingDisplayProps) {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-end gap-1.5">
            ...
            <p className="text-foreground text-base font-semibold leading-4">{rating}</p>
          </div>
          ...
          <div className="mx-auto flex items-start md:mx-0 md:w-1/2 md:items-center">
            <div className="text-center md:text-left">
              ...
              <p className="text-muted-foreground mx-auto mt-3 max-w-md text-base sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
                Gather and display testimonials from happy customers to build trust and boost your
                conversion rate.
              </p>
