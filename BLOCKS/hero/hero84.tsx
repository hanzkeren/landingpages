        ...
        <div className="mb-24 flex flex-col items-center gap-8">
          ...
          <div>
            ...
            <p className="text-foreground max-w-[820px] text-center text-xl font-medium">
              An all-in-one platform for seamless collaboration, our app merges client-facing
              portals with internal project management tools to streamline every phase of client
              projects.
            </p>
          </div>
        </div>
