      ...
      <div className="gradient container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="my-4 tracking-tight text-muted-foreground lg:px-15 lg:text-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde perferendis deserunt quis
            excepturi reiciendis nulla?
          </p>
        </div>
...
const BarChart = ({
  ...
  return (
    <div className="group relative h-full w-full">
        ...
        >
          ...
          <svg
            className={cn(
              ...
              className.includes('bg-sky-400') ? 'text-sky-400' : 'text-muted-foreground'
            )}
            width="10"
            height="10"
            viewBox="0 0 10 10"
      ...
      <p className="mx-auto mt-2 w-fit tracking-tight text-muted-foreground/80">{label}</p>
    </div>
  );
};
