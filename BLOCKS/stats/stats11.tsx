          ...
          <div>
            <h2 className="mb-16 max-w-3xl text-3xl leading-10 font-semibold sm:mb-24 md:mx-10">
              ...
              <span className="font-medium text-primary/50">
                {' '}
                Our advanced diagnostic platform helps doctors make accurate diagnoses in seconds.
              </span>
            </h2>
            <div className="relative grid max-w-2xl gap-4 border-x border-border pb-32 sm:grid-cols-2 sm:gap-10 sm:pb-44 md:ml-10 md:border-0">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="pl-5 font-medium text-muted-foreground/80">Diagnoses Made</p>
              </div>
              <div className="flex flex-col gap-2">
                <span className="flex gap-5 text-3xl font-semibold">
                  <span className="relative -left-px w-px bg-primary/50"></span>
                ...
                <p className="pl-5 font-medium text-muted-foreground/80">Diagnostic Accuracy</p>
              </div>
              <div className="flex flex-col gap-2">
                <span className="flex gap-5 text-3xl font-semibold">
                  <span className="relative -left-px w-px bg-primary/50"></span>
                ...
                <p className="pl-5 font-medium text-muted-foreground/80">Healthcare Providers</p>
              </div>
              <div className="flex flex-col gap-2">
                <span className="flex gap-5 text-3xl font-semibold">
                  <span className="relative -left-px w-px bg-primary/50"></span>
                ...
                <p className="pl-5 font-medium text-muted-foreground/80">Latency</p>
              </div>
            </div>
          </div>
        </div>
