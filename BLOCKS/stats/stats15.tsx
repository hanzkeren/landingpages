      ...
      <div className="container flex flex-col md:flex-row">
        <div className="z-10 md:flex-1">
          ...
          <p className="mt-4 max-w-xl text-muted-foreground/80">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad, distinctio eius incidunt
            doloribus quam velit sint sed alias,
          </p>
          ...
          >
            <div className="mt-auto mb-10 grid w-full grid-cols-2 gap-4 md:grid-cols-4">
              <div className="w-full text-left">
                ...
                <p className="text-sm whitespace-pre text-muted-foreground/70"> Team Members </p>
              </div>
              <div className="w-full text-left">
                <h2 className="text-4xl font-medium lg:text-5xl">
                  <NumberFlow
                    value={Stats[selectedYear as keyof typeof Stats].CompanyGrowth}
                    suffix="%"
                  />
                </h2>
                <p className="text-sm whitespace-pre text-muted-foreground/70"> Company Growth </p>
              </div>
              <div className="w-full text-left">
                <h2 className="text-4xl font-medium lg:text-5xl">
                  <NumberFlow
                    value={Stats[selectedYear as keyof typeof Stats].NewCustomers}
                    suffix="M"
                  />
                </h2>
                <p className="text-sm whitespace-pre text-muted-foreground/70"> New Customers </p>
              </div>
              <div ref={IllustrationRef} className="w-full text-left">
                <h2 className="text-4xl font-medium lg:text-5xl">
                  <NumberFlow
                    value={Stats[selectedYear as keyof typeof Stats].BigCorpClients}
                    prefix="~"
                    suffix="+"
                  />
                </h2>
                <p className="text-sm whitespace-pre text-muted-foreground/70"> Revenue </p>
              </div>
            </div>
          </div>
        </div>
