      ...
      <div className="container flex items-center justify-center">
        <DottedDiv className="h-114 w-full">
          <div className="flex h-full w-full flex-col items-center justify-center bg-muted/30">
            <p className="tracking-tight opacity-50 md:text-lg">50 new blocks every month</p>
...
const DottedDiv = ({ children, className }: { children: React.ReactNode; className?: string }) => (
  <div className={cn('relative h-full w-full overflow-hidden sm:p-4', className)}>
...
function AnimatedNumberCountdown({ endDate, startDate, className }: CountdownProps) {
