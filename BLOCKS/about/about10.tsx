              ...
              <div className="mb-8">
                <div className="mb-6 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">{profile.subtitle}</p>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    {profile.team.map(({ id, item, type }) => (
                      <div key={id} className="flex items-center justify-between border-b py-4">
                        <div className="flex items-center gap-4">
                          <span className="text-muted-foreground font-mono text-sm">{id}</span>
